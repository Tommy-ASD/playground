...
fn mels_to_text<B: Backend>(
    ...
    let mut _initial_tokens = if prev_nonspecial_tokens.len() > 0 {
...
fn _first_repetition_end(tokens: &[usize], period: usize) -> usize {
...
fn _repetition_period(tokens: &[usize], min_repetitions: usize) -> Option<usize> {
...
fn _find_repeated_tokens_index(
    tokens: &[usize],
    window_size: usize,
