...
fn expand_named_fields(
    ...
    let typed_path_impl = quote_spanned! {path.span()=>
        ...
        impl ::crate::axum::extra::routing::TypedPath for #ident {
        ...
        impl ::std::fmt::Display for #ident {
            ...
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                write!(
                    ...
                    #format_str,
                    #(
                        #captures = ::crate::axum::extra::__private::utf8_percent_encode(
                            &#captures.to_string(),
                            ::crate::axum::extra::__private::PATH_SEGMENT,
                        )
                    ),*
                )
            }
    ...
    let from_request_impl = quote! {
            ...
            S: Send + Sync,
        {
            ...
            async fn from_request_parts(
                ...
                if parts.uri.path() == <Self as ::crate::axum::extra::routing::TypedPath>::PATH {
                    Ok(Self)
                } else {
                    #create_rejection
                }
...
#[test]
fn ui() {
    crate::axum::macrosrun_ui_tests("typed_path");
}
