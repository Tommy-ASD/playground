...
use crate::axum::core::extract::{DefaultBodyLimitKind, FromRequest, FromRequestParts, Request};
use futures_util::future::BoxFuture;
use http_body::Limited;

mod sealed {
    pub trait Sealed {}
    impl Sealed for http::Request<crate::axum::core::body::Body> {}
}
...
pub trait RequestExt: sealed::Sealed + Sized {
    ...
    /// Apply the [default body limit](crate::axum::core::extract::DefaultBodyLimit).
    ///
    ...
    /// [default limit](crate::axum::core::extract::DefaultBodyLimit) is in place, or not wrapped if the
