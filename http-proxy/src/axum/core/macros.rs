...
macro_rules! __define_rejection {
    (
        ...
        impl $crate::axum::core::response::IntoResponse for $name {
            fn into_response(self) -> $crate::axum::core::response::Response {
    ...
    (
        ...
        $(#[$m])*
        #[derive(Debug)]
        pub struct $name(pub(crate) $crate::axum::core::Error);

        impl $name {
            pub(crate) fn from_err<E>(err: E) -> Self
            where
                E: Into<$crate::axum::core::BoxError>,
            {
                Self($crate::axum::core::Error::new(err))
            }
        }
...
mod composite_rejection_tests {
    use self::defs::*;
    use crate::axum::core::Error;
    use std::error::Error as _;

    #[allow(dead_code, unreachable_pub)]
    mod defs {
        use crate::axum::core::{__composite_rejection, __define_rejection};
