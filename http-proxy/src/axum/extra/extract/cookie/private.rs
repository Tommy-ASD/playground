...
/// # use crate::axum::extra::extract::cookie::{PrivateCookieJar, Cookie, Key};
/// use std::sync::Arc;
/// use std::ops::Deref;
///
/// #[derive(Clone)]
...
impl<K> PrivateCookieJar<K> {
    ...
    ///
    /// ```rust
    /// use crate::axum::extra::extract::cookie::PrivateCookieJar;
    ...
    ///
    /// ```rust
    /// use crate::axum::extra::extract::cookie::{PrivateCookieJar, Cookie};
    /// use axum::response::IntoResponse;
    ///
