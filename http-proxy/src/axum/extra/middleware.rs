...
use crate::axum::extra::either::Either;
...
///
/// ```
/// use crate::axum::extra::middleware::option_layer;
...
/// [`Infallible`].
///
/// `crate::axum::extra::middleware::option_layer` on the other hand doesn't change the error type so can
/// be applied directly.
///
