...
/// Derive an implementation of [`crate::axum::extra::routing::TypedPath`].
///
/// See that trait for more details.
///
/// [`crate::axum::extra::routing::TypedPath`]: https://docs.rs/axum-extra/latest/axum_extra/routing/trait.TypedPath.html
