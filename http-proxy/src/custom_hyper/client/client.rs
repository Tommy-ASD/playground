...
use crate::custom_hyper::client::connect::CaptureConnectionExtension;
...
pub(crate) struct Client<C, B = Body> {
    config: Config,
...
pub(crate) struct ResponseFuture {
    inner: SyncWrapper<
        Pin<Box<dyn Future<Output = crate::custom_hyper::Result<Response<Body>>> + Send>>,
    >,
}
    ...
    B::Error: Into<Box<dyn StdError + Send + Sync>>,
{
            ...
            Version::HTTP_10 => {
                if is_http_connect {
                    ...
                    return ResponseFuture::new(future::err(
                        crate::custom_hyper::Error::new_user_unsupported_request_method(),
                    ));
                }
            }
            Version::HTTP_2 => (),
    ...
    async fn retryably_send_request(
        ...
        mut req: Request<B>,
        pool_key: PoolKey,
    ) -> crate::custom_hyper::Result<Response<Body>> {
        ...
        if pooled.is_http1() {
            if req.version() == Version::HTTP_2 {
                ...
                return Err(ClientError::Normal(
                    crate::custom_hyper::Error::new_user_unsupported_version()
    ...
    fn connect_to(
        &self,
        pool_key: PoolKey,
    ) -> impl Lazy<Output = crate::custom_hyper::Result<Pooled<PoolClient<B>>>> + Unpin {
        #[cfg_attr(feature = "deprecated", allow(deprecated))]
        ...
        hyper_lazy(move || {
            ...
            let connecting = match pool.connecting(&pool_key, ver) {
                Some(lock) => lock,
                None => {
                    let canceled = crate::custom_hyper::Error::new_canceled()
            ...
            Either::Left(
                connector
                    ...
                    .map_err(crate::custom_hyper::Error::new_connect)
                    .and_then(move |io| {
...
impl ResponseFuture {
    ...
    where
        F: Future<Output = crate::custom_hyper::Result<Response<Body>>> + Send + 'static,
    {
        Self {
...
impl Future for ResponseFuture {
    type Output = crate::custom_hyper::Result<Response<Body>>;
...
impl<B> PoolClient<B> {
    fn poll_ready(&mut self, cx: &mut task::Context<'_>) -> Poll<crate::custom_hyper::Result<()>> {
        match self.tx {
...
impl<B: HttpBody + 'static> PoolClient<B> {
    fn send_request_retryable(
        &mut self,
        req: Request<B>,
    ) -> impl Future<Output = Result<Response<Body>, (crate::custom_hyper::Error, Option<Request<B>>)>>
    where
        B: Send,
    {
        match self.tx {
...
#[allow(missing_debug_implementations)]
enum ClientError<B> {
    Normal(crate::custom_hyper::Error),
    Canceled {
        connection_reused: bool,
        req: Request<B>,
        reason: crate::custom_hyper::Error,
    },
}
...
impl<B> ClientError<B> {
    fn map_with_reused(
        conn_reused: bool,
    ) -> impl Fn((crate::custom_hyper::Error, Option<Request<B>>)) -> Self {
        move |(err, orig_req)| {
...
enum ClientConnectError {
    Normal(crate::custom_hyper::Error),
    H2CheckoutIsClosed(crate::custom_hyper::Error),
}
...
fn extract_domain(uri: &mut Uri, is_http_connect: bool) -> crate::custom_hyper::Result<PoolKey> {
    ...
    match (uri_clone.scheme(), uri_clone.authority()) {
        ...
        _ => {
            ...
            Err(crate::custom_hyper::Error::new_user_absolute_uri_required())
        }
    }
}
