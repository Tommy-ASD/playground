...
use crate::custom_hyper::common::{task, Future, Pin, Poll};
...
impl Builder {
    ...
    pub(crate) fn allow_spaces_after_header_name_in_responses(
        &mut self,
        enabled: bool,
    ) -> &mut Builder {
    ...
    ///
    /// [RFC 7230 Section 3.2.4.]: https://tools.ietf.org/html/rfc7230#section-3.2.4
    pub(crate) fn allow_obsolete_multiline_headers_in_responses(
        &mut self,
        enabled: bool,
    ) -> &mut Builder {
        self.h1_parser_config
    ...
    ///
    /// Default is false.
    pub(crate) fn ignore_invalid_headers_in_responses(&mut self, enabled: bool) -> &mut Builder {
        self.h1_parser_config
    ...
    /// mode to use
    pub(crate) fn writev(&mut self, enabled: bool) -> &mut Builder {
    ...
    ///
    /// Default is false.
    pub(crate) fn title_case_headers(&mut self, enabled: bool) -> &mut Builder {
    ...
    ///
    /// Default is false.
    pub(crate) fn preserve_header_case(&mut self, enabled: bool) -> &mut Builder {
    ...
    pub(crate) fn preserve_header_order(&mut self, enabled: bool) -> &mut Builder {
    ...
    pub(crate) fn read_buf_exact_size(&mut self, sz: Option<usize>) -> &mut Builder {
