...
//!     crate::custom_tokio::net::TcpStream::connect("127.0.0.1:1337")
//! })
//! ```
//!
...
//! [`Service`]: crate::custom_hyper::service::Service
//! [`Uri`]: ::http::Uri
...
pub(crate) use self::http::{HttpConnector, HttpInfo};

pub(crate) mod dns;
mod http;

pub(crate) use self::sealed::Connect;
...
#[derive(Debug, Clone)]
pub(crate) struct CaptureConnection {
...
/// # }
/// ```
pub(crate) fn capture_connection<B>(
    request: &mut crate::custom_hyper::http::Request<B>,
) -> CaptureConnection {
...
impl CaptureConnection {
    ...
    pub(crate) fn connection_metadata(&self) -> impl Deref<Target = Option<Connected>> + '_ {
        self.rx.borrow()
    }
    ...
    pub(crate) async fn wait_for_connection_metadata(
        &mut self,
...
impl Connected {
    ...
    pub(crate) fn extra<T: Clone + Send + Sync + 'static>(mut self, extra: T) -> Connected {
...
pub(super) mod sealed {
    ...
    use crate::custom_hyper::common::{Future, Unpin};
    ...
    pub(crate) trait Connect: Sealed + Sized {
        #[doc(hidden)]
        ...
        T: AsyncRead + AsyncWrite + Connection + Unpin + Send + 'static,
    {
        ...
        fn connect(self, _: Internal, dst: Uri) -> crate::custom_hyper::service::Oneshot<S, Uri> {
            crate::custom_hyper::service::oneshot(self, dst)
        }
    }
        ...
        T: AsyncRead + AsyncWrite + Connection + Unpin + Send + 'static,
    {
        type Connection = T;
        type Error = S::Error;
        type Future = crate::custom_hyper::service::Oneshot<S, Uri>;
...
mod tests {
    use super::Connected;
    use crate::custom_hyper::client::connect::CaptureConnection;
    ...
    async fn async_capture_connection() {
        ...
        let test_task = crate::custom_tokio::spawn(async move {
            assert_eq!(
