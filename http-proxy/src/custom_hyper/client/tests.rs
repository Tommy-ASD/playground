...
async fn client_connect_uri_argument() {
    ...
    let client = Client::builder().build::<_, crate::custom_hyper::Body>(connector);
    let _ = client
...
fn retryable_request() {
    ...
    let client = Client::builder()
        .build::<_, crate::custom_hyper::Body>(connector);
...
fn checkout_win_allows_connect_future_to_be_pooled() {
    ...
    let uri = "http://mock.local/a".parse::<crate::custom_hyper::Uri>().expect("uri parse");
...
fn bench_http1_get_0b(b: &mut test::Bencher) {
    ...
    let client = Client::builder()
        .build::<_, crate::custom_hyper::Body>(connector.clone());
