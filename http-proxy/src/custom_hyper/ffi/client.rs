...
use crate::custom_hyper::client::conn;
use crate::custom_hyper::rt::Executor as _;
...
pub(crate) struct hyper_clientconn {
    tx: conn::SendRequest<crate::custom_hyper::Body>,
}
...
ffi_fn! {
    ...
    fn hyper_clientconn_handshake(io: *mut hyper_io, options: *mut hyper_clientconn_options) -> *mut hyper_task {
        ...
        Box::into_raw(hyper_task::boxed(async move {
            options.builder.handshake::<_, crate::custom_hyper::Body>(io)
                .await
                .map(|(tx, conn)| {
