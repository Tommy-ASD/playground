...
impl crate::custom_hyper::rt::Executor<BoxFuture<()>> for WeakExec {
...
unsafe impl AsTaskType for crate::custom_hyper::Error {
    fn as_task_type(&self) -> hyper_task_return_type {
...
impl<T> IntoDynTaskType for crate::custom_hyper::Result<T>
where
