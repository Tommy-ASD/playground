...
pub(crate) use crate::custom_hyper::http::{
    header, Method, Request, Response, StatusCode, Uri, Version,
};

#[doc(no_inline)]
pub(crate) use crate::custom_hyper::http::HeaderMap;

pub(crate) use crate::custom_hyper::body::Body;
pub(crate) use crate::custom_hyper::error::{Error, Result};
...
pub(crate) use crate::custom_hyper::client::Client;

pub(crate) mod server;
#[doc(no_inline)]
pub(crate) use crate::custom_hyper::server::Server;
