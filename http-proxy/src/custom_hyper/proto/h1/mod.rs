...
pub(crate) type ParseResult<T> =
    Result<Option<ParsedMessage<T>>, crate::custom_hyper::error::Parse>;
...
pub(crate) struct ParseContext<'a> {
    ...
    h09_responses: bool,
    on_informational: &'a mut Option<crate::custom_hyper::ffi::OnInformational>,
    raw_headers: bool,
}
