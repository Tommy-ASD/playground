...
pin_project_lite::pin_project! {
    ...
    pub(crate) struct Connection<T, S>
    where
    ...
    B::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub(crate) fn with_upgrades(self) -> upgrades::UpgradeableConnection<I, S>
    where
        I: Send,
    {
...
impl Builder {
    ...
    ///
    /// Default is `false`.
    pub(crate) fn half_close(&mut self, val: bool) -> &mut Self {
    ...
    ///
    /// Default is false.
    pub(crate) fn title_case_headers(&mut self, enabled: bool) -> &mut Self {
    ...
    ///
    /// Default is false.
    pub(crate) fn preserve_header_case(&mut self, enabled: bool) -> &mut Self {
    ...
    ///
    /// Default is None.
    pub(crate) fn header_read_timeout(&mut self, read_timeout: Duration) -> &mut Self {
    ...
    /// mode to use
    pub(crate) fn writev(&mut self, val: bool) -> &mut Self {
    ...
    /// # fn main() {}
    /// ```
    pub(crate) fn serve_connection<I, S>(&self, io: I, service: S) -> Connection<I, S>
    where
        S: HttpService<IncomingBody>,
        S::Error: Into<Box<dyn StdError + Send + Sync>>,
        S::ResBody: 'static,
...
mod upgrades {
    ...
    pub(crate) struct UpgradeableConnection<T, S>
    where
        S: HttpService<IncomingBody>,
    {
