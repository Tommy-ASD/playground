...
pin_project! {
    ...
    pub(crate) struct Connection<T, S, E>
    where
...
impl<E> Builder<E> {
    ...
    pub(crate) fn max_concurrent_streams(&mut self, max: impl Into<Option<u32>>) -> &mut Self {
    ...
    pub(crate) fn enable_connect_protocol(&mut self) -> &mut Self {
    ...
    pub(crate) fn max_header_list_size(&mut self, max: u32) -> &mut Self {
        self.h2_builder.max_header_list_size = max;
        self
    }

    // /// Set the timer used in background tasks.
    // pub(crate) fn timer<M>(&mut self, timer: M) -> &mut Self
    // where
