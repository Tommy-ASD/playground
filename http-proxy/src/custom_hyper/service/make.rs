...
pub(crate) trait MakeServiceRef<Target, ReqBody>:
    self::sealed::Sealed<(Target, ReqBody)>
{
...
/// # fn main() {}
/// ```
pub(crate) fn make_service_fn<F, Target, Ret>(f: F) -> MakeServiceFn<F>
where
    F: FnMut(&Target) -> Ret,
    Ret: Future,
{
...
#[derive(Clone, Copy)]
pub(crate) struct MakeServiceFn<F> {
    f: F,
}
...
mod sealed {
    ...
    pub(crate) trait CantImpl {}

    #[allow(missing_debug_implementations)]
    pub(crate) enum CantName {}
