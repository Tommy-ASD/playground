...
//! # MakeService
//!
//! Since a `Service` is bound to a single connection, a [`Server`](crate::custom_hyper::Server)
...
pub(crate) use self::make::make_service_fn;
pub(crate) use self::util::service_fn;
