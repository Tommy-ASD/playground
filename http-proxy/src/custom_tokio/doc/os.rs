...
pub(crate)mod windows {
    ...
    pub(crate)mod io {
        ...
        pub(crate)type RawHandle = crate::custom_tokio::doc::NotDefinedHere;

        /// See [std::os::windows::io::OwnedHandle](https://doc.rust-lang.org/std/os/windows/io/struct.OwnedHandle.html)
        pub(crate)type OwnedHandle = crate::custom_tokio::doc::NotDefinedHere;
        ...
        pub(crate)type BorrowedHandle<'handle> = crate::custom_tokio::doc::NotDefinedHere;
        ...
        pub(crate)type BorrowedSocket<'socket> = crate::custom_tokio::doc::NotDefinedHere;
