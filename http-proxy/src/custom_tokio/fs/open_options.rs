use crate::custom_tokio::fs::{asyncify, File};
...
///
/// ```no_run
/// use crate::custom_tokio::fs::OpenOptions;
/// use std::io;
///
...
impl OpenOptions {
    ...
    /// }
    /// ```
    pub(crate) fn read(&mut self, read: bool) -> &mut OpenOptions {
        self.0.read(read);
        self
    }
    ...
    /// }
    /// ```
    pub(crate) fn write(&mut self, write: bool) -> &mut OpenOptions {
        self.0.write(write);
        self
    }
    ...
    /// method to do so.
    ///
    /// [`write()`]: crate::custom_tokio::io::AsyncWriteExt::write
    /// [`flush()`]: crate::custom_tokio::io::AsyncWriteExt::flush
    /// [`seek`]: crate::custom_tokio::io::AsyncSeekExt::seek
    ...
    /// }
    /// ```
    pub(crate) fn append(&mut self, append: bool) -> &mut OpenOptions {
    ...
    /// }
    /// ```
    pub(crate) fn truncate(&mut self, truncate: bool) -> &mut OpenOptions {
    ...
    /// }
    /// ```
    pub(crate) fn create(&mut self, create: bool) -> &mut OpenOptions {
    ...
    /// }
    /// ```
    pub(crate) fn create_new(&mut self, create_new: bool) -> &mut OpenOptions {
    ...
    pub(crate) async fn open(&self, path: impl AsRef<Path>) -> io::Result<File> {
    ...
    pub(crate) fn as_inner_mut(&mut self) -> &mut StdOpenOptions {
        &mut self.0
    }
}
...
feature! {
    ...
    impl OpenOptions {
        ...
        /// }
        /// ```
        pub(crate)fn mode(&mut self, mode: u32) -> &mut OpenOptions {
        ...
        /// }
        /// ```
        pub(crate)fn custom_flags(&mut self, flags: i32) -> &mut OpenOptions {
...
cfg_windows! {
    impl OpenOptions {
        ...
        pub(crate)fn access_mode(&mut self, access: u32) -> &mut OpenOptions {
        ...
        ///
        /// [`CreateFile`]: https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilea
        pub(crate)fn share_mode(&mut self, share: u32) -> &mut OpenOptions {
        ...
        pub(crate)fn custom_flags(&mut self, flags: u32) -> &mut OpenOptions {
            self.as_inner_mut().custom_flags(flags);
            self
        }
        ...
        /// [`CreateFile`]: https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilea
        /// [`CreateFile2`]: https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfile2
        pub(crate)fn attributes(&mut self, attributes: u32) -> &mut OpenOptions {
        ...
        pub(crate)fn security_qos_flags(&mut self, flags: u32) -> &mut OpenOptions {
