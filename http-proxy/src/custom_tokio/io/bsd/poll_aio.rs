...
impl<E: AioSource> Aio<E> {
    ...
    /// [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter) function.
    pub(crate)fn new_for_aio(io: E) -> io::Result<Self> {
    ...
    ///
    /// [`lio_listio`]: https://pubs.opengroup.org/onlinepubs/9699919799/functions/lio_listio.html
    pub(crate)fn new_for_lio(io: E) -> io::Result<Self> {
    ...
    ///
    /// [`lio_listio`]: https://pubs.opengroup.org/onlinepubs/9699919799/functions/lio_listio.html
    pub(crate)fn clear_ready(&self, ev: AioEvent) {
    ...
    pub(crate)fn poll_ready<'a>(&'a self, cx: &mut Context<'_>) -> Poll<io::Result<AioEvent>> {
...
#[derive(Debug)]
pub(crate)struct AioEvent(ReadyEvent);
