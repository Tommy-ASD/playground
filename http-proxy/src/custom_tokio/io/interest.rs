...
pub(crate) struct Interest(usize);
...
impl Interest {
    ...
    cfg_aio! {
        ...
        #[cfg(target_os = "freebsd")]
        pub(crate)const AIO: Interest = Interest(AIO);

        /// Interest for POSIX AIO.
        #[cfg(not(target_os = "freebsd"))]
        pub(crate)const AIO: Interest = Interest(READABLE);

        /// Interest for POSIX AIO lio_listio events.
        #[cfg(target_os = "freebsd")]
        pub(crate)const LIO: Interest = Interest(LIO);

        /// Interest for POSIX AIO lio_listio events.
        #[cfg(not(target_os = "freebsd"))]
        pub(crate)const LIO: Interest = Interest(READABLE);
    }
    ...
    pub(crate) const ERROR: Interest = Interest(ERROR);

    /// Returns a `Interest` set representing priority completion interests.
    #[cfg(any(target_os = "linux", target_os = "android"))]
    #[cfg_attr(docsrs, doc(cfg(any(target_os = "linux", target_os = "android"))))]
    pub(crate) const PRIORITY: Interest = Interest(PRIORITY);
