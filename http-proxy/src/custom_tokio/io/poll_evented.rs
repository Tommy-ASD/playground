...
use crate::custom_tokio::runtime::io::Registration;
...
cfg_io_driver! {
    ...
    /// [`TcpListener`]: crate::custom_tokio::net::TcpListener
...
impl<E: Source> PollEvented<E> {
    ...
    /// explicitly with [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter)
    /// function.
    #[track_caller]
    #[cfg_attr(feature = "signal", allow(unused))]
...
feature! {
    ...
    use crate::custom_tokio::io::ReadBuf;
