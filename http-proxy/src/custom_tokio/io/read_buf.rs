...
impl<'a> ReadBuf<'a> {
    ...
    #[inline]
    pub(crate)fn new(buf: &'a mut [u8]) -> ReadBuf<'a> {
    ...
    #[inline]
    pub(crate)fn take(&mut self, n: usize) -> ReadBuf<'_> {
    ...
    #[inline]
    pub(crate)unsafe fn inner_mut(&mut self) -> &mut [MaybeUninit<u8>] {
        self.buf
    }
    ...
    /// This includes any bytes in the region marked as uninitialized by `ReadBuf`.
    #[inline]
    pub(crate)unsafe fn unfilled_mut(&mut self) -> &mut [MaybeUninit<u8>] {
