use crate::custom_tokio::io::blocking::Blocking;
use crate::custom_tokio::io::stdio_common::SplitByUtf8BoundaryIfWindows;
...
cfg_io_std! {
    ...
    /// [`write_all`]: crate::custom_tokio::io::AsyncWriteExt::write_all()
    ///
    /// # Examples
    ///
    /// ```
...
cfg_windows! {
    use crate::custom_tokio::os::windows::io::{AsHandle, BorrowedHandle, AsRawHandle, RawHandle};
