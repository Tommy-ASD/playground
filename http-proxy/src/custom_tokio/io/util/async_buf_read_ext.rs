use crate::custom_tokio::io::util::fill_buf::{fill_buf, FillBuf};
use crate::custom_tokio::io::util::lines::{lines, Lines};
use crate::custom_tokio::io::util::read_line::{read_line, ReadLine};
use crate::custom_tokio::io::util::read_until::{read_until, ReadUntil};
use crate::custom_tokio::io::util::split::{split, Split};
...
cfg_io_util! {
    ...
    pub(crate)trait AsyncBufReadExt: AsyncBufRead {
        ...
        /// [`lines`]: Self::lines
        /// [`next_line`]: crate::custom_tokio::io::Lines::next_line
        ///
        /// # Examples
        ///
        ...
        ///
        /// [`consume`]: crate::custom_tokio::io::AsyncBufReadExt::consume
        ...
        ///
        /// [`read`]: crate::custom_tokio::io::AsyncReadExt::read
        /// [`fill_buf`]: crate::custom_tokio::io::AsyncBufReadExt::fill_buf
