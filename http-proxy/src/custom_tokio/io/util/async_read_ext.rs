use crate::custom_tokio::io::util::chain::{chain, Chain};
use crate::custom_tokio::io::util::read::{read, Read};
use crate::custom_tokio::io::util::read_buf::{read_buf, ReadBuf};
use crate::custom_tokio::io::util::read_exact::{read_exact, ReadExact};
use crate::custom_tokio::io::util::read_int::{ReadF32, ReadF32Le, ReadF64, ReadF64Le};
use crate::custom_tokio::io::util::read_int::{
...
use crate::custom_tokio::io::util::read_to_end::{read_to_end, ReadToEnd};
use crate::custom_tokio::io::util::read_to_string::{read_to_string, ReadToString};
use crate::custom_tokio::io::util::take::{take, Take};
use crate::custom_tokio::io::AsyncRead;
...
cfg_io_util! {
    ...
    /// ```
    ///
    /// See [module][crate::custom_tokio::io] documentation for more details.
    ///
    /// [`AsyncRead`]: AsyncRead
    pub(crate)trait AsyncReadExt: AsyncRead {
        ...
        /// # Examples
        ///
        /// [`File`][crate::custom_tokio::fs::File]s implement `AsyncRead`:
        ///
        /// ```no_run
        /// use crate::custom_tokio::fs::File;
        /// use crate::custom_tokio::io::{self, AsyncReadExt};
        ...
        /// # Examples
        ///
        /// [`File`][crate::custom_tokio::fs::File]s implement `Read`:
        ///
        /// ```no_run
        /// use crate::custom_tokio::fs::File;
        /// use crate::custom_tokio::io::{self, AsyncReadExt};
        ...
        /// event in a [`crate::custom_tokio::select!`](crate::custom_tokio::select) statement and some
        ...
        /// ```
        ///
        /// (See also the [`crate::custom_tokio::fs::read`] convenience function for reading from a
        /// file.)
        ///
        /// [`crate::custom_tokio::fs::read`]: fn@crate::custom_tokio::fs::read
        ...
        /// ```
        ///
        /// (See also the [`crate::custom_tokio::fs::read_to_string`] convenience function for
        /// reading from a file.)
        ///
        /// [`crate::custom_tokio::fs::read_to_string`]: fn@crate::custom_tokio::fs::read_to_string
