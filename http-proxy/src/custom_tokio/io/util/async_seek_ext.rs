use crate::custom_tokio::io::seek::{seek, Seek};
use crate::custom_tokio::io::AsyncSeek;
use std::io::SeekFrom;
...
cfg_io_util! {
    ...
    /// use crate::custom_tokio::io::{AsyncSeekExt, AsyncReadExt};
    ///
    ...
    ///
    /// [`AsyncSeek`]: AsyncSeek
    pub(crate)trait AsyncSeekExt: AsyncSeek {
