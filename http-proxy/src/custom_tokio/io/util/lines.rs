use crate::custom_tokio::io::util::read_line::read_line_internal;
...
pin_project! {
    ...
    /// [`lines`]: crate::custom_tokio::io::AsyncBufReadExt::lines
    #[derive(Debug)]
    ...
    R: AsyncBufRead + Unpin,
{
    ...
    pub(crate) fn get_ref(&mut self) -> &R {
        &self.reader
    }
