use crate::custom_tokio::io::util::read_line::finish_string_read;
use crate::custom_tokio::io::util::read_to_end::read_to_end_internal;
use crate::custom_tokio::io::util::vec_with_initialized::VecWithInitialized;
...
pin_project! {
    ...
    pub(crate)struct ReadToString<'a, R: ?Sized> {
        reader: &'a mut R,
