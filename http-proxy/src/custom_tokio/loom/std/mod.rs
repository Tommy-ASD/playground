...
pub(crate) mod future {
    pub(crate) use crate::custom_tokio::sync::AtomicWaker;
}
...
pub(crate) mod sync {
    ...
    pub(crate) use crate::custom_tokio::loom::std::parking_lot::{
    ...
    #[cfg(not(all(feature = "parking_lot", not(miri))))]
    pub(crate) use crate::custom_tokio::loom::std::mutex::Mutex;

    pub(crate) mod atomic {
        pub(crate) use crate::custom_tokio::loom::std::atomic_u16::AtomicU16;
        pub(crate) use crate::custom_tokio::loom::std::atomic_u32::AtomicU32;
        pub(crate) use crate::custom_tokio::loom::std::atomic_u64::{AtomicU64, StaticAtomicU64};
        pub(crate) use crate::custom_tokio::loom::std::atomic_usize::AtomicUsize;
