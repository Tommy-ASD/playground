cfg_net! {
    use crate::custom_tokio::net::addr::{self, ToSocketAddrs};
    ...
    /// }
    /// ```
    pub(crate)async fn lookup_host<T>(host: T) -> io::Result<impl Iterator<Item = SocketAddr>>
    where
        T: ToSocketAddrs
    {
