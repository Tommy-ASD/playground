use crate::custom_tokio::io::{Interest, PollEvented};
use crate::custom_tokio::net::tcp::TcpStream;
...
impl TcpListener {
    cfg_not_wasi! {
        ...
        /// }
        /// ```
        pub(crate)async fn bind<A: ToSocketAddrs>(addr: A) -> io::Result<TcpListener> {
    ...
    #[track_caller]
    pub(crate) fn from_std(listener: net::TcpListener) -> io::Result<TcpListener> {
        let io = mio::net::TcpListener::from_std(listener);
        let io = PollEvented::new(io)?;
        Ok(TcpListener { io })
    }

    /// Turns a [`crate::custom_tokio::net::TcpListener`] into a [`std::net::TcpListener`].
    ///
    ...
    /// #[crate::custom_tokio::main]
    /// async fn main() -> Result<(), Box<dyn Error>> {
    ///     let tokio_listener = crate::custom_tokio::net::TcpListener::bind("127.0.0.1:0").await?;
    ...
    /// ```
    ///
    /// [`crate::custom_tokio::net::TcpListener`]: TcpListener
    /// [`std::net::TcpListener`]: std::net::TcpListener
    /// [`set_nonblocking`]: fn@std::net::TcpListener::set_nonblocking
    pub(crate) fn into_std(self) -> io::Result<std::net::TcpListener> {
        #[cfg(unix)]
        {
