...
cfg_windows! {
    use crate::custom_tokio::os::windows::io::{AsRawSocket, FromRawSocket, IntoRawSocket, RawSocket, AsSocket, BorrowedSocket};
}
...
cfg_net! {
    ...
    ///
    /// ```no_run
    /// use crate::custom_tokio::net::TcpSocket;
    ///
    /// use std::io;
    ///
...
impl TcpSocket {
    ...
    /// }
    /// ```
    pub(crate) fn new_v4() -> io::Result<TcpSocket> {
    ...
    /// }
    /// ```
    pub(crate) fn new_v6() -> io::Result<TcpSocket> {
    ...
    /// }
    /// ```
    pub(crate) fn reuseaddr(&self) -> io::Result<bool> {
    ...
    pub(crate) fn set_reuseport(&self, reuseport: bool) -> io::Result<()> {
    ...
    pub(crate) fn reuseport(&self) -> io::Result<bool> {
    ...
    pub(crate) fn set_send_buffer_size(&self, size: u32) -> io::Result<()> {
    ...
    pub(crate) fn send_buffer_size(&self) -> io::Result<u32> {
    ...
    pub(crate) fn set_recv_buffer_size(&self, size: u32) -> io::Result<()> {
    ...
    pub(crate) fn recv_buffer_size(&self) -> io::Result<u32> {
    ...
    /// }
    /// ```
    pub(crate) fn listen(self, backlog: u32) -> io::Result<TcpListener> {
    ...
    /// }
    /// ```
    pub(crate) fn from_std_stream(std_stream: std::net::TcpStream) -> TcpSocket {
        #[cfg(unix)]
        {
            use std::os::unix::io::{FromRawFd, IntoRawFd};
