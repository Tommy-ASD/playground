...
use crate::custom_tokio::net::tcp::split::{split, ReadHalf, WriteHalf};
use crate::custom_tokio::net::tcp::split_owned::{split_owned, OwnedReadHalf, OwnedWriteHalf};
...
cfg_net! {
    ...
    /// [accepting]: method@crate::custom_tokio::net::TcpListener::accept
    /// [listener]: struct@crate::custom_tokio::net::TcpListener
    /// [`TcpSocket`]: struct@crate::custom_tokio::net::TcpSocket
    /// [`AsyncReadExt`]: trait@crate::custom_tokio::io::AsyncReadExt
    /// [`AsyncWriteExt`]: trait@crate::custom_tokio::io::AsyncWriteExt
    ///
    /// # Examples
    ///
    /// ```no_run
    /// use crate::custom_tokio::net::TcpStream;
    ...
    ///
    /// [`write_all`]: fn@crate::custom_tokio::io::AsyncWriteExt::write_all
    /// [`AsyncWriteExt`]: trait@crate::custom_tokio::io::AsyncWriteExt
    ///
    ...
    ///
    /// [`shutdown()`]: fn@crate::custom_tokio::io::AsyncWriteExt::shutdown
...
impl TcpStream {
    cfg_not_wasi! {
        ...
        /// [`write_all`]: fn@crate::custom_tokio::io::AsyncWriteExt::write_all
        /// [`AsyncWriteExt`]: trait@crate::custom_tokio::io::AsyncWriteExt
        pub(crate)async fn connect<A: ToSocketAddrs>(addr: A) -> io::Result<TcpStream> {
    ...
    #[track_caller]
    pub(crate) fn from_std(stream: std::net::TcpStream) -> io::Result<TcpStream> {
        let io = mio::net::TcpStream::from_std(stream);
        let io = PollEvented::new(io)?;
        Ok(TcpStream { io })
    }

    /// Turns a [`crate::custom_tokio::net::TcpStream`] into a [`std::net::TcpStream`].
    ///
    ...
    /// #   let handle = crate::custom_tokio::spawn(async {
    ...
    /// }
    /// ```
    /// [`crate::custom_tokio::net::TcpStream`]: TcpStream
    /// [`std::net::TcpStream`]: std::net::TcpStream
    /// [`set_nonblocking`]: fn@std::net::TcpStream::set_nonblocking
    pub(crate) fn into_std(self) -> io::Result<std::net::TcpStream> {
        #[cfg(unix)]
        {
    ...
    ///
    /// ```no_run
    /// use crate::custom_tokio::io::{self, ReadBuf};
    /// use crate::custom_tokio::net::TcpStream;
    ///
    ...
    ///
    /// [`read`]: fn@crate::custom_tokio::io::AsyncReadExt::read
    /// [`AsyncReadExt`]: trait@crate::custom_tokio::io::AsyncReadExt
    ...
    pub(crate) fn shutdown_std(&self, how: Shutdown) -> io::Result<()> {
    ...
    cfg_not_wasi! {
        ...
        /// # }
        /// ```
        pub(crate)fn set_linger(&self, dur: Option<Duration>) -> io::Result<()> {
    ...
    pub(crate) fn split<'a>(&'a mut self) -> (ReadHalf<'a>, WriteHalf<'a>) {
        split(self)
    }
    ...
    pub(crate) fn poll_write_vectored_priv(
        &self,
        cx: &mut Context<'_>,
        bufs: &[io::IoSlice<'_>],
    ) -> Poll<io::Result<usize>> {
...
cfg_windows! {
    use crate::custom_tokio::os::windows::io::{AsRawSocket, RawSocket, AsSocket, BorrowedSocket};
