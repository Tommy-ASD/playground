...
use crate::custom_tokio::io::interest::Interest;
use crate::custom_tokio::io::{AsyncRead, AsyncWrite, PollEvented, ReadBuf, Ready};
...
///
/// ```no_run
/// use crate::custom_tokio::net::unix::pipe;
/// # use std::error::Error;
///
...
impl OpenOptions {
    ...
    pub(crate) fn read_write(&mut self, value: bool) -> &mut Self {
    ...
    /// # }
    /// ```
    pub(crate) fn unchecked(&mut self, value: bool) -> &mut Self {
    ...
    pub(crate) fn open_receiver<P: AsRef<Path>>(&self, path: P) -> io::Result<Receiver> {
    ...
    /// from a future driven by a tokio runtime, otherwise runtime can be set
    /// explicitly with [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter) function.
    pub(crate) fn open_sender<P: AsRef<Path>>(&self, path: P) -> io::Result<Sender> {
...
impl Sender {
    ...
    /// from a future driven by a tokio runtime, otherwise runtime can be set
    /// explicitly with [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter) function.
    pub(crate) fn from_file(mut file: File) -> io::Result<Sender> {
        if !is_fifo(&file)? {
            return Err(io::Error::new(io::ErrorKind::InvalidInput, "not a pipe"));
        }
    ...
    /// from a future driven by a tokio runtime, otherwise runtime can be set
    /// explicitly with [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter) function.
    pub(crate) fn from_file_unchecked(file: File) -> io::Result<Sender> {
...
/// ```
///
/// [`read_to_end`]: crate::custom_tokio::io::AsyncReadExt::read_to_end
#[derive(Debug)]
...
impl Receiver {
    ...
    /// from a future driven by a tokio runtime, otherwise runtime can be set
    /// explicitly with [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter) function.
    pub(crate) fn from_file(mut file: File) -> io::Result<Receiver> {
        if !is_fifo(&file)? {
            return Err(io::Error::new(io::ErrorKind::InvalidInput, "not a pipe"));
        }
    ...
    /// from a future driven by a tokio runtime, otherwise runtime can be set
    /// explicitly with [`Runtime::enter`](crate::custom_tokio::runtime::Runtime::enter) function.
    pub(crate) fn from_file_unchecked(file: File) -> io::Result<Receiver> {
        let raw_fd = file.into_raw_fd();
