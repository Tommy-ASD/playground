...
use crate::custom_tokio::io::{AsyncRead, AsyncWrite, Interest, ReadBuf, Ready};
...
///
/// [`UnixStream`]: crate::custom_tokio::net::UnixStream
/// [`into_split`]: crate::custom_tokio::net::UnixStream::into_split()
/// [`AsyncReadExt`]: trait@crate::custom_tokio::io::AsyncReadExt
#[derive(Debug)]
pub(crate)struct OwnedReadHalf {
...
/// [`poll_shutdown`]: fn@crate::custom_tokio::io::AsyncWrite::poll_shutdown
/// [`AsyncWriteExt`]: trait@crate::custom_tokio::io::AsyncWriteExt
#[derive(Debug)]
pub(crate)struct OwnedWriteHalf {
    inner: Arc<UnixStream>,
...
/// not be reunited.
#[derive(Debug)]
pub(crate)struct ReuniteError(pub(crate)OwnedReadHalf, pub(crate)OwnedWriteHalf);
...
impl OwnedReadHalf {
    ...
    ///
    /// [`into_split`]: crate::custom_tokio::net::UnixStream::into_split()
    pub(crate)fn reunite(self, other: OwnedWriteHalf) -> Result<UnixStream, ReuniteError> {
        reunite(self, other)
    }
...
impl OwnedWriteHalf {
    ...
    ///
    /// [`into_split`]: crate::custom_tokio::net::UnixStream::into_split()
    pub(crate)fn reunite(self, other: OwnedReadHalf) -> Result<UnixStream, ReuniteError> {
        reunite(other, self)
    }
