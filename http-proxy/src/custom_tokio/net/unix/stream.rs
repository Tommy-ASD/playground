...
use crate::custom_tokio::net::unix::split::{split, ReadHalf, WriteHalf};
use crate::custom_tokio::net::unix::split_owned::{split_owned, OwnedReadHalf, OwnedWriteHalf};
use crate::custom_tokio::net::unix::ucred::{self, UCred};
...
cfg_net_unix! {
    ...
    /// [`UnixListener::accept`]: crate::custom_tokio::net::UnixListener::accept
...
impl UnixStream {
    ...
    /// handle.
    pub(crate) async fn connect<P>(path: P) -> io::Result<UnixStream>
    where
        P: AsRef<Path>,
    {
    ...
    /// use crate::custom_tokio::net::UnixStream;
    /// use std::error::Error;
    /// use std::io;
    ///
    ...
    #[track_caller]
    pub(crate) fn from_std(stream: net::UnixStream) -> io::Result<UnixStream> {
    ...
    /// Turns a [`crate::custom_tokio::net::UnixStream`] into a [`std::os::unix::net::UnixStream`].
    ///
    ...
    /// use std::error::Error;
    /// use std::io::Read;
    /// use crate::custom_tokio::net::UnixListener;
    /// # use crate::custom_tokio::net::UnixStream;
