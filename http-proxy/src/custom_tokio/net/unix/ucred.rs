use crate::custom_tokio::net::unix;
...
impl UCred {
    ...
    pub(crate)fn uid(&self) -> unix::uid_t {
        self.uid
    }

    /// Gets GID (group ID) of the process.
    pub(crate)fn gid(&self) -> unix::gid_t {
        self.gid
    }
    ...
    pub(crate)fn pid(&self) -> Option<unix::pid_t> {
        self.pid
    }
}
...
pub(crate) mod impl_linux {
    use crate::custom_tokio::net::unix::{self, UnixStream};
...
pub(crate) mod impl_aix {
    use crate::custom_tokio::net::unix::UnixStream;
    use std::io;
    use std::os::unix::io::AsRawFd;
