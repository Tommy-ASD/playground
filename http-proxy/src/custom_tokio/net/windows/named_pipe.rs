...
use crate::custom_tokio::io::{AsyncRead, AsyncWrite, Interest, PollEvented, ReadBuf, Ready};
use crate::custom_tokio::os::windows::io::{
...
#[cfg(not(docsrs))]
mod doc {
    pub(crate) use crate::custom_tokio::os::windows::ffi::OsStrExt;
    ...
    pub(crate) use mio::windows as mio_windows;
}

// NB: none of these shows up in public API, so don't document them.
#[cfg(docsrs)]
mod doc {
    pub(crate) mod mio_windows {
        pub(crate) type NamedPipe = crate::custom_tokio::doc::NotDefinedHere;
    }
}
...
/// ```no_run
/// use std::io;
/// use crate::custom_tokio::net::windows::named_pipe::ServerOptions;
///
/// const PIPE_NAME: &str = r"\\.\pipe\named-pipe-idiomatic-server";
///
/// # #[crate::custom_tokio::main] async fn main() -> std::io::Result<()> {
...
/// let server = crate::custom_tokio::spawn(async move {
///     loop {
...
///
///         let client = crate::custom_tokio::spawn(async move {
...
#[derive(Debug)]
pub(crate) struct NamedPipeServer {
...
impl NamedPipeServer {
    ...
    ///
    /// [Tokio Runtime]: crate::custom_tokio::runtime::Runtime
    /// [enabled I/O]: crate::custom_tokio::runtime::Builder::enable_io
    pub(crate) unsafe fn from_raw_handle(handle: RawHandle) -> io::Result<Self> {
    ...
    ///
    /// ```no_run
    /// use crate::custom_tokio::net::windows::named_pipe::{PipeEnd, PipeMode, ServerOptions};
    ///
    ...
    /// # Ok(()) }
    /// ```
    pub(crate) fn info(&self) -> io::Result<PipeInfo> {
    ...
    /// event in a [`select!`](crate::custom_tokio::select) statement and some other branch
    ...
    /// # Ok(()) }
    /// ```
    pub(crate) async fn connect(&self) -> io::Result<()> {
    ...
    ///
    /// ```
    /// use crate::custom_tokio::io::AsyncWriteExt;
    /// use crate::custom_tokio::net::windows::named_pipe::{ClientOptions, ServerOptions};
    ...
    ///
    /// ```no_run
    /// use crate::custom_tokio::io::Interest;
    /// use crate::custom_tokio::net::windows::named_pipe;
    /// use std::error::Error;
    /// use std::io;
    ///
    ...
    cfg_io_util! {
        ...
        /// }
        /// ```
        pub(crate)fn try_read_buf<B: BufMut>(&self, buf: &mut B) -> io::Result<usize> {
    ...
    /// }
    /// ```
    pub(crate) fn try_write_vectored(&self, buf: &[io::IoSlice<'_>]) -> io::Result<usize> {
        self.io
            .registration()
...
/// use crate::custom_tokio::net::windows::named_pipe::ClientOptions;
...
/// [Windows named pipe]: https://docs.microsoft.com/en-us/windows/win32/ipc/named-pipes
#[derive(Debug)]
pub(crate) struct NamedPipeClient {
    io: PollEvented<mio_windows::NamedPipe>,
}
...
impl NamedPipeClient {
    ...
    ///
    /// ```no_run
    /// use crate::custom_tokio::net::windows::named_pipe::{ClientOptions, PipeEnd, PipeMode};
    ///
...
impl ServerOptions {
    ...
    /// # Ok(()) }
    /// ```
    pub(crate) fn new() -> ServerOptions {
        ServerOptions {
            access_inbound: true,
    ...
    pub(crate) fn pipe_mode(&mut self, pipe_mode: PipeMode) -> &mut Self {
    ...
    ///
    /// # #[crate::custom_tokio::main] async fn main() -> io::Result<()> {
    ...
    ///
    /// let ((), read) = crate::custom_tokio::try_join!(write, read)?;
    ///
    /// assert_eq!(read, 4);
    /// assert_eq!(&buf[..], b"ping");
    /// # Ok(()) }
    /// ```
    pub(crate) fn access_inbound(&mut self, allowed: bool) -> &mut Self {
    ...
    /// # Ok(()) }
    /// ```
    pub(crate) fn access_outbound(&mut self, allowed: bool) -> &mut Self {
    ...
    pub(crate) fn first_pipe_instance(&mut self, first: bool) -> &mut Self {
    ...
    pub(crate) fn write_dac(&mut self, requested: bool) -> &mut Self {
    ...
    pub(crate) fn write_owner(&mut self, requested: bool) -> &mut Self {
    ...
    pub(crate) fn access_system_security(&mut self, requested: bool) -> &mut Self {
    ...
    pub(crate) fn reject_remote_clients(&mut self, reject: bool) -> &mut Self {
    ...
    /// ```
    /// use std::io;
    /// use crate::custom_tokio::net::windows::named_pipe::{ServerOptions, ClientOptions};
    /// use windows_sys::Win32::Foundation::ERROR_PIPE_BUSY;
    ///
    ...
    /// ```
    #[track_caller]
    pub(crate) fn max_instances(&mut self, instances: usize) -> &mut Self {
    ...
    pub(crate) fn out_buffer_size(&mut self, buffer: u32) -> &mut Self {
    ...
    pub(crate) fn in_buffer_size(&mut self, buffer: u32) -> &mut Self {
    ...
    /// # Ok(()) }
    /// ```
    pub(crate) fn create(&self, addr: impl AsRef<OsStr>) -> io::Result<NamedPipeServer> {
    ...
    pub(crate) unsafe fn create_with_security_attributes_raw(
        &self,
...
impl ClientOptions {
    ...
    /// [`CreateFile`]: https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilew
    pub(crate) fn read(&mut self, allowed: bool) -> &mut Self {
    ...
    /// [`CreateFile`]: https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilew
    pub(crate) fn write(&mut self, allowed: bool) -> &mut Self {
    ...
    /// # Ok(()) }
    /// ```
    pub(crate) fn open(&self, addr: impl AsRef<OsStr>) -> io::Result<NamedPipeClient> {
    ...
    /// [`CreateFile`]: https://docs.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilew
    /// [`SECURITY_ATTRIBUTES`]: https://docs.rs/windows-sys/latest/windows_sys/Win32/Security/struct.SECURITY_ATTRIBUTES.html
    pub(crate) unsafe fn open_with_security_attributes_raw(
        &self,
        addr: impl AsRef<OsStr>,
        attrs: *mut c_void,
