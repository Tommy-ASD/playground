...
use crate::custom_tokio::io::{AsyncRead, AsyncWrite, PollEvented, ReadBuf};
use crate::custom_tokio::process::kill::Kill;
use crate::custom_tokio::process::SpawnedChild;
use crate::custom_tokio::runtime::signal::Handle as SignalHandle;
use crate::custom_tokio::signal::unix::{signal, Signal, SignalKind};
...
cfg_not_has_const_mutex_new! {
    fn get_orphan_queue() -> &'static OrphanQueueImpl<StdChild> {
        use crate::custom_tokio::util::once_cell::OnceCell;
...
pub(crate) fn stdio<T>(io: T) -> io::Result<ChildStdio>
where
    T: IntoRawFd,
{
