...
use crate::custom_tokio::signal::unix::{signal_with_handle, SignalKind};
...
pub(crate) mod test {
    use super::*;
    use crate::custom_tokio::runtime::io::Driver as IoDriver;
    use crate::custom_tokio::runtime::signal::{Driver as SignalDriver, Handle as SignalHandle};
    use crate::custom_tokio::sync::watch;
