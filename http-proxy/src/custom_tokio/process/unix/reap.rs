use crate::custom_tokio::process::imp::orphan::{OrphanQueue, Wait};
use crate::custom_tokio::process::kill::Kill;
use crate::custom_tokio::signal::unix::InternalStream;
...
mod test {
    ...
    use crate::custom_tokio::process::unix::orphan::test::MockQueue;
