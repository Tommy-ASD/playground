use crate::custom_tokio::runtime::handle::Handle;
use crate::custom_tokio::runtime::{blocking, driver, Callback, HistogramBuilder, Runtime};
use crate::custom_tokio::util::rand::{RngSeed, RngSeedGenerator};
...
///
/// ```
/// use crate::custom_tokio::runtime::Builder;
///
/// fn main() {
///     // build runtime
...
cfg_unstable! {
    ...
    pub(crate)enum UnhandledPanic {
        ...
        ///
        /// ```
        /// use crate::custom_tokio::runtime::{self, UnhandledPanic};
        ///
        /// # pub(crate)fn main() {
        ...
        /// ```
        ///
        /// [`JoinHandle`]: struct@crate::custom_tokio::task::JoinHandle
        Ignore,
        ...
        /// rt.block_on(async {
        ///     // Do some work
        /// # loop { crate::custom_tokio::task::yield_now().await; }
        /// })
        /// # }
        /// ```
        ///
...
impl Builder {
    ...
    pub(crate) fn new_current_thread() -> Builder {
        #[cfg(loom)]
    ...
    cfg_not_wasi! {
        ...
        pub(crate)fn new_multi_thread() -> Builder {
            // The number `61` is fairly arbitrary. I believe this value was copied from golang.
        ...
        cfg_unstable! {
            ...
            #[cfg(feature = "rt-multi-thread")]
            #[cfg_attr(docsrs, doc(cfg(feature = "rt-multi-thread")))]
            pub(crate)fn new_multi_thread_alt() -> Builder {
                // The number `61` is fairly arbitrary. I believe this value was copied from golang.
    ...
    ///     .unwrap();
    /// ```
    pub(crate) fn enable_all(&mut self) -> &mut Self {
        #[cfg(any(
            feature = "net",
    ...
    #[track_caller]
    pub(crate) fn worker_threads(&mut self, val: usize) -> &mut Self {
    ...
    /// [`fs`]: mod@crate::custom_tokio::fs
    /// [`ToSocketAddrs`]: trait@crate::custom_tokio::net::ToSocketAddrs
    /// [`Stdout`]: struct@crate::custom_tokio::io::Stdout
    /// [`Stdin`]: struct@crate::custom_tokio::io::Stdin
    /// [`Stderr`]: struct@crate::custom_tokio::io::Stderr
    /// [`worker_threads`]: Self::worker_threads
    /// [`thread_keep_alive`]: Self::thread_keep_alive
    #[track_caller]
    #[cfg_attr(docsrs, doc(alias = "max_threads"))]
    pub(crate) fn max_blocking_threads(&mut self, val: usize) -> &mut Self {
    ...
    /// # }
    /// ```
    pub(crate) fn thread_name(&mut self, val: impl Into<String>) -> &mut Self {
        let val = val.into();
    ...
    /// # }
    /// ```
    pub(crate) fn thread_name_fn<F>(&mut self, f: F) -> &mut Self
    where
    ...
    /// # }
    /// ```
    pub(crate) fn thread_stack_size(&mut self, val: usize) -> &mut Self {
    ...
    /// ```
    #[cfg(not(loom))]
    pub(crate) fn on_thread_start<F>(&mut self, f: F) -> &mut Self
    where
    ...
    /// ```
    #[cfg(not(loom))]
    pub(crate) fn on_thread_stop<F>(&mut self, f: F) -> &mut Self
    where
        F: Fn() + Send + Sync + 'static,
    {
    ...
    /// `f` is called within the Tokio context, so functions like [`crate::custom_tokio::spawn`](crate::custom_tokio::spawn)
    ...
    /// # use crate::custom_tokio::runtime;
    /// # use crate::custom_tokio::sync::Barrier;
    /// # pub(crate)fn main() {
    ...
    ///                 crate::custom_tokio::spawn(async move { barrier.wait().await; });
    ///            }
    ///         }
    ///     })
    ///     .build()
    ...
    /// ```
    #[cfg(not(loom))]
    pub(crate) fn on_thread_park<F>(&mut self, f: F) -> &mut Self
    where
        F: Fn() + Send + Sync + 'static,
    {
    ...
    /// ```
    #[cfg(not(loom))]
    pub(crate) fn on_thread_unpark<F>(&mut self, f: F) -> &mut Self
    where
        F: Fn() + Send + Sync + 'static,
    {
    ...
    /// });
    /// ```
    pub(crate) fn build(&mut self) -> io::Result<Runtime> {
        match &self.kind {
    ...
    /// # }
    /// ```
    pub(crate) fn thread_keep_alive(&mut self, duration: Duration) -> &mut Self {
    ...
    /// # }
    /// ```
    pub(crate) fn global_queue_interval(&mut self, val: u32) -> &mut Self {
    ...
    /// # }
    /// ```
    pub(crate) fn event_interval(&mut self, val: u32) -> &mut Self {
    ...
    cfg_unstable! {
        ...
        ///
        /// [`JoinHandle`]: struct@crate::custom_tokio::task::JoinHandle
        pub(crate)fn unhandled_panic(&mut self, behavior: UnhandledPanic) -> &mut Self {
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn disable_lifo_slot(&mut self) -> &mut Self {
        ...
        /// deterministic (e.g. the [`crate::custom_tokio::select!`] macro). In the case of
        /// [`crate::custom_tokio::select!`] it will ensure that the order that branches are
        ...
        ///
        /// ```
        /// # use crate::custom_tokio::runtime::{self, RngSeed};
        /// # pub(crate)fn main() {
        ...
        /// ```
        ///
        /// [`crate::custom_tokio::select!`]: crate::custom_tokio::select
        pub(crate)fn rng_seed(&mut self, seed: RngSeed) -> &mut Self {
    ...
    cfg_metrics! {
        ...
        /// ```
        ///
        /// [`Handle::metrics()`]: crate::custom_tokio::runtime::Handle::metrics
        /// [`Instant::now()`]: std::time::Instant::now
        pub(crate)fn enable_metrics_poll_count_histogram(&mut self) -> &mut Self {
        ...
        ///
        /// ```
        /// use crate::custom_tokio::runtime::{self, HistogramScale};
        ///
        /// let rt = runtime::Builder::new_multi_thread()
        ///     .enable_metrics_poll_count_histogram()
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn metrics_poll_count_histogram_scale(&mut self, histogram_scale: crate::custom_tokio::runtime::HistogramScale) -> &mut Self {
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn metrics_poll_count_histogram_resolution(&mut self, resolution: Duration) -> &mut Self {
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn metrics_poll_count_histogram_buckets(&mut self, buckets: usize) -> &mut Self {
    ...
    fn build_current_thread_runtime(&mut self) -> io::Result<Runtime> {
        use crate::custom_tokio::runtime::scheduler::{self, CurrentThread};
        use crate::custom_tokio::runtime::{runtime::Scheduler, Config};
...
cfg_io_driver! {
    impl Builder {
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn enable_io(&mut self) -> &mut Self {
            self.enable_io = true;
            self
        }
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn max_io_events_per_tick(&mut self, capacity: usize) -> &mut Self {
...
cfg_time! {
    impl Builder {
        ...
        ///
        /// Doing this enables using `crate::custom_tokio::time` on the runtime.
        ///
        /// # Examples
        ///
        /// ```
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn enable_time(&mut self) -> &mut Self {
...
cfg_test_util! {
    impl Builder {
        ...
        ///     .unwrap();
        /// ```
        pub(crate)fn start_paused(&mut self, start_paused: bool) -> &mut Self {
...
cfg_rt_multi_thread! {
    impl Builder {
        fn build_threaded_runtime(&mut self) -> io::Result<Runtime> {
            use crate::custom_tokio::loom::sys::num_cpus;
            use crate::custom_tokio::runtime::{Config, runtime::Scheduler};
            use crate::custom_tokio::runtime::scheduler::{self, MultiThread};
        ...
        cfg_unstable! {
            fn build_alt_threaded_runtime(&mut self) -> io::Result<Runtime> {
                use crate::custom_tokio::loom::sys::num_cpus;
                use crate::custom_tokio::runtime::{Config, runtime::Scheduler};
                use crate::custom_tokio::runtime::scheduler::MultiThreadAlt;
