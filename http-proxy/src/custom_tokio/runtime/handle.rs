...
use crate::custom_tokio::runtime::{context, scheduler, RuntimeFlavor};
...
///
/// [`Runtime::handle`]: crate::custom_tokio::runtime::Runtime::handle()
#[derive(Debug, Clone)]
...
use crate::custom_tokio::runtime::task::JoinHandle;
use crate::custom_tokio::util::error::{CONTEXT_MISSING_ERROR, THREAD_LOCAL_DESTROYED_ERROR};
...
///
/// [`Runtime::enter`]: fn@crate::custom_tokio::runtime::Runtime::enter
#[derive(Debug)]
...
impl Handle {
    ...
    /// [`crate::custom_tokio::spawn`] and [`Handle::current`] without panicking.
    ///
    /// # Panics
    ///
    ...
    ///
    /// let _guard = rt.enter();
    /// crate::custom_tokio::spawn(async {
    ///     println!("Hello world!");
    /// });
    /// ```
    ///
    ...
    /// ```
    ///
    /// [`Sleep`]: struct@crate::custom_tokio::time::Sleep
    /// [`TcpStream`]: struct@crate::custom_tokio::net::TcpStream
    /// [`crate::custom_tokio::spawn`]: fn@crate::custom_tokio::spawn
    pub(crate) fn enter(&self) -> EnterGuard<'_> {
        EnterGuard {
            _guard: match context::try_set_current(&self.inner) {
                ...
                None => panic!(
                    "{}",
                    crate::custom_tokio::util::error::THREAD_LOCAL_DESTROYED_ERROR
                ),
            },
    ...
    /// # let rt = Runtime::new().unwrap();
    /// # rt.spawn(async {
    /// use crate::custom_tokio::runtime::Handle;
    ///
    ...
    /// ```
    ///
    /// [`JoinError`]: struct@crate::custom_tokio::task::JoinError
    /// [`JoinHandle`]: struct@crate::custom_tokio::task::JoinHandle
    /// [`Runtime::block_on`]: fn@crate::custom_tokio::runtime::Runtime::block_on
    /// [`Runtime::shutdown_background`]: fn@crate::custom_tokio::runtime::Runtime::shutdown_background
    /// [`Runtime::shutdown_timeout`]: fn@crate::custom_tokio::runtime::Runtime::shutdown_timeout
    ...
    pub(crate) fn block_on<F: Future>(&self, future: F) -> F::Output {
        ...
        let future = crate::custom_tokio::util::trace::task(
            future,
            "block_on",
            None,
    ...
    where
        ...
        F::Output: Send + 'static,
    {
        let id = crate::custom_tokio::runtime::task::Id::next();
        #[cfg(all(
            tokio_unstable,
            tokio_taskdump,
            feature = "rt",
        ...
        let future = super::task::trace::Trace::root(future);
        #[cfg(all(tokio_unstable, feature = "tracing"))]
        let future = crate::custom_tokio::util::trace::task(future, "task", _name, id.as_u64());
    ...
    ///
    /// ```
    /// use crate::custom_tokio::runtime::{Handle, RuntimeFlavor};
    ///
    /// #[crate::custom_tokio::main(flavor = "current_thread")]
    /// async fn main() {
    ...
    /// use crate::custom_tokio::runtime::{Handle, RuntimeFlavor};
    ///
    /// #[crate::custom_tokio::main(flavor = "multi_thread", worker_threads = 4)]
    /// async fn main() {
    ///   assert_eq!(RuntimeFlavor::MultiThread, Handle::current().runtime_flavor());
    /// }
    /// ```
    pub(crate) fn runtime_flavor(&self) -> RuntimeFlavor {
        match self.inner {
    ...
    cfg_unstable! {
        ...
        /// [`Id`]: struct@crate::custom_tokio::runtime::Id
        pub(crate)fn id(&self) -> runtime::Id {
...
cfg_metrics! {
    use crate::custom_tokio::runtime::RuntimeMetrics;
...
cfg_taskdump! {
    impl Handle {
        ...
        /// [timeout][crate::custom_tokio::time::timeout], so that dumping does not escalate a
        ...
        ///       └╼ crate::custom_tokio::sync::barrier::Barrier::wait::{{closure}} at /tokio/tokio/src/sync/barrier.rs:129:10
        ///          └╼ <crate::custom_tokio::util::trace::InstrumentedAsyncOp<F> as core::future::future::Future>::poll at /tokio/tokio/src/util/trace.rs:77:46
        ///             └╼ crate::custom_tokio::sync::barrier::Barrier::wait_internal::{{closure}} at /tokio/tokio/src/sync/barrier.rs:183:36
        ///                └╼ crate::custom_tokio::sync::watch::Receiver<T>::changed::{{closure}} at /tokio/tokio/src/sync/watch.rs:604:55
        ///                   └╼ crate::custom_tokio::sync::watch::changed_impl::{{closure}} at /tokio/tokio/src/sync/watch.rs:755:18
        ///                      └╼ <crate::custom_tokio::sync::notify::Notified as core::future::future::Future>::poll at /tokio/tokio/src/sync/notify.rs:1103:9
        ///                         └╼ crate::custom_tokio::sync::notify::Notified::poll_notified at /tokio/tokio/src/sync/notify.rs:996:32
        /// ```
        ///
        /// # Requirements
        ///
        ...
        /// [`LocalSet`][crate::custom_tokio::task::LocalSet]) may not appear in task dumps.
        ///
        ...
        pub(crate)async fn dump(&self) -> crate::custom_tokio::runtime::Dump {
            match &self.inner {
    ...
    cfg_rt_multi_thread! {
        ...
        {
            let (tx, rx) = crate::custom_tokio::sync::oneshot::channel();
            crate::custom_tokio::loom::thread::spawn(|| {
                let rt = crate::custom_tokio::runtime::Builder::new_current_thread().build().unwrap();
                rt.block_on(async {
...
impl TryCurrentError {
    ...
    /// the Tokio context.
    pub(crate) fn is_missing_context(&self) -> bool {
    ...
    /// other thread-locals.
    pub(crate) fn is_thread_local_destroyed(&self) -> bool {
