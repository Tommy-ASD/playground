...
use crate::custom_tokio::io::ready::Ready;
use crate::custom_tokio::loom::sync::atomic::AtomicUsize;
use crate::custom_tokio::loom::sync::Mutex;
use crate::custom_tokio::runtime::io::{Direction, ReadyEvent, Tick};
use crate::custom_tokio::util::bit;
...
pub(crate) struct ScheduledIo {
    pub(crate) linked_list_pointers: UnsafeCell<linked_list::Pointers<Self>>,
...
impl ScheduledIo {
    ...
    ///   readiness.
    pub(crate) fn set_readiness(&self, tick: Tick, f: impl Fn(Ready) -> Ready) {
