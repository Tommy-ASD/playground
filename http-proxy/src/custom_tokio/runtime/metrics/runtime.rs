...
///
/// [`Runtime::metrics`]: crate::custom_tokio::runtime::Runtime::metrics()
#[derive(Clone, Debug)]
...
impl RuntimeMetrics {
    ...
    /// #[crate::custom_tokio::main]
    /// async fn main() {
    ///     let _ = crate::custom_tokio::task::spawn_blocking(move || {
    ...
    /// }
    /// ```
    pub(crate) fn remote_schedule_count(&self) -> u64 {
        self.handle
            .inner
            .scheduler_metrics()
    ...
    /// }
    /// ```
    pub(crate) fn worker_noop_count(&self, worker: usize) -> u64 {
        self.handle
            .inner
            .worker_metrics(worker)
            .noop_count
    ...
    /// }
    /// ```
    pub(crate) fn worker_steal_operations(&self, worker: usize) -> u64 {
        self.handle
            .inner
            .worker_metrics(worker)
            .steal_operations
    ...
    /// }
    /// ```
    pub(crate) fn worker_poll_count(&self, worker: usize) -> u64 {
        self.handle
            .inner
            .worker_metrics(worker)
            .poll_count
    ...
    /// }
    /// ```
    pub(crate) fn worker_local_schedule_count(&self, worker: usize) -> u64 {
        self.handle
            .inner
            .worker_metrics(worker)
    ...
    /// }
    /// ```
    pub(crate) fn worker_overflow_count(&self, worker: usize) -> u64 {
        self.handle
            .inner
            .worker_metrics(worker)
            .overflow_count
    ...
    ///
    /// ```
    /// use crate::custom_tokio::runtime::{self, Handle};
    ///
    /// fn main() {
    ...
    /// ```
    ///
    /// [`enable_metrics_poll_count_histogram()`]: crate::custom_tokio::runtime::Builder::enable_metrics_poll_count_histogram
    /// [`Instant::now()`]: std::time::Instant::now
    pub(crate) fn poll_count_histogram_enabled(&self) -> bool {
        self.handle
            .inner
            .worker_metrics(0)
    ...
    ///     crate::custom_tokio::runtime::Builder::metrics_poll_count_histogram_buckets
    pub(crate) fn poll_count_histogram_num_buckets(&self) -> usize {
        self.handle
            .inner
            .worker_metrics(0)
            .poll_count_histogram
    ...
    ///     crate::custom_tokio::runtime::Builder::metrics_poll_count_histogram_resolution
    #[track_caller]
    pub(crate) fn poll_count_histogram_bucket_range(&self, bucket: usize) -> Range<Duration> {
        self.handle
            .inner
            .worker_metrics(0)
            .poll_count_histogram
    ...
    /// ```
    ///
    /// [`poll_count_histogram_bucket_range()`]: crate::custom_tokio::runtime::RuntimeMetrics::poll_count_histogram_bucket_range
    #[track_caller]
    pub(crate) fn poll_count_histogram_bucket_count(&self, worker: usize, bucket: usize) -> u64 {
        self.handle
            .inner
            .worker_metrics(worker)
            .poll_count_histogram
    ...
    /// ```
    #[track_caller]
    pub(crate) fn worker_mean_poll_time(&self, worker: usize) -> Duration {
        let nanos = self
            .handle
            .inner
            .worker_metrics(worker)
...
cfg_net! {
    impl RuntimeMetrics {
        ...
        /// }
        /// ```
        pub(crate)fn io_driver_fd_registered_count(&self) -> u64 {
        ...
        /// }
        /// ```
        pub(crate)fn io_driver_fd_deregistered_count(&self) -> u64 {
            self.with_io_driver_metrics(|m| {
        ...
        /// }
        /// ```
        pub(crate)fn io_driver_ready_count(&self) -> u64 {
