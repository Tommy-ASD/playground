use crate::custom_tokio::runtime::blocking::BlockingPool;
use crate::custom_tokio::runtime::scheduler::CurrentThread;
use crate::custom_tokio::runtime::{context, EnterGuard, Handle};
use crate::custom_tokio::task::JoinHandle;
...
cfg_rt_multi_thread! {
    ...
    use crate::custom_tokio::runtime::scheduler::MultiThread;
...
/// However, most users will use the `#[crate::custom_tokio::main]` annotation on their
/// entry point instead.
///
...
/// as [`crate::custom_tokio::spawn`] will use the runtime whose context you are inside.
///
/// [timer]: crate::custom_tokio::time
/// [mod]: index.html
/// [`new`]: method@Self::new
...
///
/// This is the return type for [`Handle::runtime_flavor`](crate::custom_tokio::runtime::Handle::runtime_flavor()).
...
impl Runtime {
    ...
    cfg_not_wasi! {
        ...
        /// they will use the  [`#[crate::custom_tokio::main]` attribute][main]. When a more complex
        ...
        pub(crate)fn new() -> std::io::Result<Runtime> {
    ...
    pub(crate) fn block_on<F: Future>(&self, future: F) -> F::Output {
        ...
        let future = crate::custom_tokio::util::trace::task(
            ...
            "block_on",
            None,
            crate::custom_tokio::runtime::task::Id::next().as_u64(),
        );
    ...
    /// also allow you to call methods such as [`crate::custom_tokio::spawn`].
    ///
    ...
    ///
    ///     // By entering the context, we tie `crate::custom_tokio::spawn` to this executor.
    ///     let _guard = rt.enter();
    ...
    /// }
    /// ```
    pub(crate) fn shutdown_timeout(mut self, duration: Duration) {
...
cfg_metrics! {
    impl Runtime {
        /// TODO
        pub(crate)fn metrics(&self) -> crate::custom_tokio::runtime::RuntimeMetrics {
            self.handle.metrics()
        }
    }
}
