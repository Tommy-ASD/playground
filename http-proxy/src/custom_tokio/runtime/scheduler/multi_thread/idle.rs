...
use crate::custom_tokio::runtime::scheduler::multi_thread::Shared;
...
impl Idle {
    ...
    pub(crate) fn worker_to_notify(&self, shared: &Shared) -> Option<usize> {
    ...
    /// work.
    pub(crate) fn transition_worker_to_parked(
        &self,
        shared: &Shared,
        worker: usize,
        is_searching: bool,
    ...
    pub(crate) fn transition_worker_to_searching(&self) -> bool {
    ...
    pub(crate) fn unpark_worker_by_id(&self, shared: &Shared, worker_id: usize) -> bool {
        let mut lock = shared.synced.lock();
    ...
    pub(crate) fn is_parked(&self, shared: &Shared, worker_id: usize) -> bool {
