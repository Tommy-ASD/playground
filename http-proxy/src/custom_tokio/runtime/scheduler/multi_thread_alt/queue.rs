...
use crate::custom_tokio::runtime::scheduler::multi_thread_alt::{Overflow, Stats};
...
cfg_has_atomic_u64! {
    ...
    type AtomicUnsignedShort = crate::custom_tokio::loom::sync::atomic::AtomicU32;
    type AtomicUnsignedLong = crate::custom_tokio::loom::sync::atomic::AtomicU64;
}
cfg_not_has_atomic_u64! {
    type UnsignedShort = u16;
    type UnsignedLong = u32;
    type AtomicUnsignedShort = crate::custom_tokio::loom::sync::atomic::AtomicU16;
    type AtomicUnsignedLong = crate::custom_tokio::loom::sync::atomic::AtomicU32;
}
