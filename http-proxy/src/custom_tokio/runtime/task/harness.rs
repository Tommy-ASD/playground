...
use crate::custom_tokio::runtime::task::core::{Cell, Core, Header, Trailer};
use crate::custom_tokio::runtime::task::state::{Snapshot, State};
use crate::custom_tokio::runtime::task::waker::waker_ref;
use crate::custom_tokio::runtime::task::{Id, JoinError, Notified, RawTask, Schedule, Task};
...
impl RawTask {
    ...
    pub(crate) fn try_set_join_waker(&self, waker: &Waker) -> bool {
    ...
    S: Schedule,
{
    ...
    pub(crate) fn try_read_output(self, dst: &mut Poll<super::Result<T::Output>>, waker: &Waker) {
