...
///   task via the [`task::try_id()`](crate::custom_tokio::task::try_id()) and
///   [`task::id()`](crate::custom_tokio::task::id()) functions and from outside the task via
///   the [`JoinHandle::id()`](crate::custom_tokio::task::JoinHandle::id()) function.
///
...
/// panic, see [`task::try_id()`](crate::custom_tokio::runtime::task::try_id()).
///
/// **Note**: This is an [unstable API][unstable]. The public API of this type
/// may break in 1.x releases. See [the documentation on unstable
/// features][unstable] for details.
...
/// of a task.
///
/// This function is similar to  [`task::id()`](crate::custom_tokio::runtime::task::id()), except
...
impl Id {
    pub(crate) fn next() -> Self {
        use crate::custom_tokio::loom::sync::atomic::{Ordering::Relaxed, StaticAtomicU64};
