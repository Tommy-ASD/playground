...
impl State {
    ...
    pub(crate) fn transition_to_terminal(&self, count: usize) -> bool {
    ...
    pub(crate) fn unset_join_interested(&self) -> UpdateResult {
    ...
    /// Returns `true` if the task should be released.
    pub(crate) fn ref_dec_twice(&self) -> bool {
