...
use crate::custom_tokio::runtime::scheduler::{self, current_thread, Inject};
...
impl Context {
    ...
    where
        F: FnOnce(&Self) -> R,
    {
        crate::custom_tokio::runtime::context::with_trace(f)
    }
...
pub(in crate::custom_tokio::runtime) fn trace_current_thread(
...
cfg_rt_multi_thread! {
    ...
    use crate::custom_tokio::runtime::scheduler::multi_thread::Synced;
    use crate::custom_tokio::runtime::scheduler::inject::Shared;
    ...
    pub(in crate::custom_tokio::runtime) unsafe fn trace_multi_thread(
