...
fn spawn_mandatory_blocking_should_always_run() {
    use crate::custom_tokio::runtime::tests::loom_oneshot;
    loom::model(|| {
...
fn spawn_blocking_when_paused() {
    ...
    loom::model(|| {
        ...
        let _enter = handle.enter();
        let a = crate::custom_tokio::task::spawn_blocking(|| {});
        let b = crate::custom_tokio::task::spawn_blocking(|| {});
        rt.block_on(crate::custom_tokio::time::timeout(Duration::from_millis(1), async move {
