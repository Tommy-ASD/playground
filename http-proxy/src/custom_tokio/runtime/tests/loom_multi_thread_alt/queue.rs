use crate::custom_tokio::runtime::scheduler::multi_thread::{queue, Stats};
use crate::custom_tokio::runtime::tests::{unowned, NoopSchedule};

use loom::thread;
use std::cell::RefCell;

fn new_stats() -> Stats {
    Stats::new(&crate::custom_tokio::runtime::WorkerMetrics::new())
}
