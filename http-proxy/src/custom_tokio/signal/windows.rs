...
///
/// ```rust,no_run
/// use crate::custom_tokio::signal::windows::ctrl_c;
///
...
/// }
/// ```
pub(crate) fn ctrl_c() -> io::Result<CtrlC> {
    Ok(CtrlC {
...
impl CtrlC {
    ...
    /// use std::task::{Context, Poll};
    /// use crate::custom_tokio::signal::windows::CtrlC;
    ///
    /// struct MyFuture {
    ///     ctrl_c: CtrlC,
    /// }
...
impl CtrlBreak {
    ...
    ///
    /// ```rust,no_run
    /// use crate::custom_tokio::signal::windows::ctrl_break;
    ///
    /// #[crate::custom_tokio::main]
    /// async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    /// use std::future::Future;
    /// use std::task::{Context, Poll};
    /// use crate::custom_tokio::signal::windows::CtrlBreak;
    ///
    /// struct MyFuture {
...
/// }
/// ```
pub(crate) fn ctrl_break() -> io::Result<CtrlBreak> {
    Ok(CtrlBreak {
...
///
/// ```rust,no_run
/// use crate::custom_tokio::signal::windows::ctrl_close;
///
/// #[crate::custom_tokio::main]
/// async fn main() -> Result<(), Box<dyn std::error::Error>> {
...
/// }
/// ```
pub(crate) fn ctrl_close() -> io::Result<CtrlClose> {
    Ok(CtrlClose {
...
impl CtrlClose {
    ...
    /// use std::future::Future;
    /// use std::task::{Context, Poll};
    /// use crate::custom_tokio::signal::windows::CtrlClose;
    ///
    /// struct MyFuture {
...
///
/// ```rust,no_run
/// use crate::custom_tokio::signal::windows::ctrl_shutdown;
///
/// #[crate::custom_tokio::main]
/// async fn main() -> Result<(), Box<dyn std::error::Error>> {
...
/// }
/// ```
pub(crate) fn ctrl_shutdown() -> io::Result<CtrlShutdown> {
    Ok(CtrlShutdown {
...
impl CtrlShutdown {
    ...
    /// use std::future::Future;
    /// use std::task::{Context, Poll};
    /// use crate::custom_tokio::signal::windows::CtrlShutdown;
    ///
    /// struct MyFuture {
...
///
/// ```rust,no_run
/// use crate::custom_tokio::signal::windows::ctrl_logoff;
///
/// #[crate::custom_tokio::main]
/// async fn main() -> Result<(), Box<dyn std::error::Error>> {
...
/// }
/// ```
pub(crate) fn ctrl_logoff() -> io::Result<CtrlLogoff> {
    Ok(CtrlLogoff {
...
impl CtrlLogoff {
    ...
    /// use std::future::Future;
    /// use std::task::{Context, Poll};
    /// use crate::custom_tokio::signal::windows::CtrlLogoff;
    ///
    /// struct MyFuture {
