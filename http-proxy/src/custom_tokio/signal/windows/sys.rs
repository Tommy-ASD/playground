...
use crate::custom_tokio::signal::registry::{globals, EventId, EventInfo, Init, Storage};
...
mod tests {
    ...
    fn ctrl_c() {
        ...
        let mut ctrl_c = task::spawn(crate::custom_tokio::signal::ctrl_c());
    ...
    fn ctrl_break() {
        ...
        rt.block_on(async {
            let mut ctrl_break = assert_ok!(crate::custom_tokio::signal::windows::ctrl_break());
    ...
    fn ctrl_close() {
        ...
        rt.block_on(async {
            let mut ctrl_close = assert_ok!(crate::custom_tokio::signal::windows::ctrl_close());
    ...
    fn ctrl_shutdown() {
        ...
        rt.block_on(async {
            let mut ctrl_shutdown =
                assert_ok!(crate::custom_tokio::signal::windows::ctrl_shutdown());
    ...
    fn ctrl_logoff() {
        ...
        rt.block_on(async {
            let mut ctrl_logoff = assert_ok!(crate::custom_tokio::signal::windows::ctrl_logoff());
