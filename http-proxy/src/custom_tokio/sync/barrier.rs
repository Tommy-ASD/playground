...
///     handles.push(crate::custom_tokio::spawn(async move {
///         println!("before wait");
...
impl Barrier {
    ...
    #[track_caller]
    pub(crate) fn new(mut n: usize) -> Barrier {
        let (waker, wait) = crate::custom_tokio::sync::watch::channel(0);
    ...
    pub(crate) async fn wait(&self) -> BarrierWaitResult {
        #[cfg(all(tokio_unstable, feature = "tracing"))]
