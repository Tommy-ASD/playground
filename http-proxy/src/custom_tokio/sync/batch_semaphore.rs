...
use crate::custom_tokio::loom::sync::{Mutex, MutexGuard};
use crate::custom_tokio::util::linked_list::{self, LinkedList};
...
///
/// [`Semaphore::try_acquire`]: crate::custom_tokio::sync::Semaphore::try_acquire
#[derive(Debug, PartialEq, Eq)]
pub(crate)enum TryAcquireError {
    /// The semaphore has been [closed] and cannot issue new permits.
    ///
    /// [closed]: crate::custom_tokio::sync::Semaphore::close
    Closed,
...
///
/// [closed]: crate::custom_tokio::sync::Semaphore::close
/// [`Semaphore::acquire`]: crate::custom_tokio::sync::Semaphore::acquire
#[derive(Debug)]
