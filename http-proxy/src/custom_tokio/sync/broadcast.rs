...
//!
//! [`Sender`]: crate::custom_tokio::sync::broadcast::Sender
//! [`Sender::subscribe`]: crate::custom_tokio::sync::broadcast::Sender::subscribe
//! [`Receiver`]: crate::custom_tokio::sync::broadcast::Receiver
//! [`channel`]: crate::custom_tokio::sync::broadcast::channel
//! [`RecvError::Lagged`]: crate::custom_tokio::sync::broadcast::error::RecvError::Lagged
//! [`RecvError::Closed`]: crate::custom_tokio::sync::broadcast::error::RecvError::Closed
//! [`recv`]: crate::custom_tokio::sync::broadcast::Receiver::recv
//!
//! # Examples
//!
//! Basic usage
...
use crate::custom_tokio::loom::sync::{Arc, Mutex, MutexGuard, RwLock, RwLockReadGuard};
use crate::custom_tokio::util::linked_list::{self, GuardedLinkedList, LinkedList};
use crate::custom_tokio::util::WakeList;
...
pub(crate) mod error {
    ...
    ///
    /// [`send`]: crate::custom_tokio::sync::broadcast::Sender::send
    /// [`Sender`]: crate::custom_tokio::sync::broadcast::Sender
    #[derive(Debug)]
    ...
    ///
    /// [`try_recv`]: crate::custom_tokio::sync::broadcast::Receiver::try_recv
    /// [`Receiver`]: crate::custom_tokio::sync::broadcast::Receiver
    #[derive(Debug, PartialEq, Eq, Clone)]
...
/// [`Receiver`]: crate::custom_tokio::sync::broadcast::Receiver
/// [`recv`]: crate::custom_tokio::sync::broadcast::Receiver::recv
/// [`SendError`]: crate::custom_tokio::sync::broadcast::error::SendError
/// [`RecvError`]: crate::custom_tokio::sync::broadcast::error::RecvError
///
/// # Examples
///
/// ```
...
impl<T> Sender<T> {
    ...
    ///
    /// [`Receiver`]: crate::custom_tokio::sync::broadcast::Receiver
    /// [`subscribe`]: crate::custom_tokio::sync::broadcast::Sender::subscribe
    ///
    /// # Examples
    ///
    /// ```
...
impl<T: Clone> Receiver<T> {
    ...
    /// }
    pub(crate) fn blocking_recv(&mut self) -> Result<T, RecvError> {
