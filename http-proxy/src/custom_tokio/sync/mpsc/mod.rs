...
//!
//! [`Sender`]: crate::custom_tokio::sync::mpsc::Sender
//! [`Receiver`]: crate::custom_tokio::sync::mpsc::Receiver
//! [bounded-send]: crate::custom_tokio::sync::mpsc::Sender::send()
//! [bounded-recv]: crate::custom_tokio::sync::mpsc::Receiver::recv()
//! [blocking-send]: crate::custom_tokio::sync::mpsc::Sender::blocking_send()
//! [blocking-recv]: crate::custom_tokio::sync::mpsc::Receiver::blocking_recv()
//! [`UnboundedSender`]: crate::custom_tokio::sync::mpsc::UnboundedSender
//! [`UnboundedReceiver`]: crate::custom_tokio::sync::mpsc::UnboundedReceiver
//! [oneshot]: crate::custom_tokio::sync::oneshot
//! [`Handle::block_on`]: crate::custom_tokio::runtime::Handle::block_on()
//! [std-unbounded]: std::sync::mpsc::channel
//! [crossbeam-unbounded]: https://docs.rs/crossbeam/*/crossbeam/channel/fn.unbounded.html
//! [`send_timeout`]: crate::custom_tokio::sync::mpsc::Sender::send_timeout

pub(crate) mod block;

mod bounded;
pub(crate)use self::bounded::{channel, OwnedPermit, Permit, Receiver, Sender, WeakSender};
