...
///
/// ```
/// use crate::custom_tokio::sync::OnceCell;
///
...
impl<T> OnceCell<T> {
    ...
    ///
    /// [`OnceCell::new`]: crate::custom_tokio::sync::OnceCell::new
    ...
    pub(crate) fn new_with(value: Option<T>) -> Self {
        if let Some(v) = value {
            OnceCell::from(v)
        } else {
            OnceCell::new()
    ...
    ///
    /// [`SetError::AlreadyInitializedError`]: crate::custom_tokio::sync::SetError::AlreadyInitializedError
    /// [`SetError::InitializingError`]: crate::custom_tokio::sync::SetError::InitializingError
...
///
/// [`OnceCell::set`]: crate::custom_tokio::sync::OnceCell::set
#[derive(Debug, PartialEq, Eq)]
pub(crate) enum SetError<T> {
...
impl<T> SetError<T> {
    ...
    pub(crate) fn is_already_init_err(&self) -> bool {
        match self {
    ...
    pub(crate) fn is_initializing_err(&self) -> bool {
        match self {
