use crate::custom_tokio::sync::batch_semaphore::Semaphore;
use crate::custom_tokio::sync::rwlock::read_guard::RwLockReadGuard;
use crate::custom_tokio::sync::rwlock::write_guard_mapped::RwLockMappedWriteGuard;
...
/// on [`RwLock`].
///
/// [`write`]: method@crate::custom_tokio::sync::RwLock::write
...
impl<'a, T: ?Sized> RwLockWriteGuard<'a, T> {
    ...
    ///
    /// ```
    /// use crate::custom_tokio::sync::{RwLock, RwLockWriteGuard};
    ///
    ...
    /// ```
    #[inline]
    pub(crate) fn map<F, U: ?Sized>(mut this: Self, f: F) -> RwLockMappedWriteGuard<'a, U>
    where
    ...
    /// ```
    #[inline]
    pub(crate) fn downgrade_map<F, U: ?Sized>(this: Self, f: F) -> RwLockReadGuard<'a, U>
    where
        F: FnOnce(&T) -> &U,
    {
    ...
    #[inline]
    pub(crate) fn into_mapped(this: Self) -> RwLockMappedWriteGuard<'a, T> {
    ...
    ///
    /// [`RwLock`]: struct@crate::custom_tokio::sync::RwLock
    pub(crate) fn downgrade(self) -> RwLockReadGuard<'a, T> {
