...
///
/// [mapping]: method@crate::custom_tokio::sync::RwLockWriteGuard::map
/// [`RwLockWriteGuard`]: struct@crate::custom_tokio::sync::RwLockWriteGuard
#[clippy::has_significant_drop]
pub(crate) struct RwLockMappedWriteGuard<'a, T: ?Sized> {
