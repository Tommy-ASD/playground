...
///
/// ```
/// use crate::custom_tokio::sync::{Semaphore, TryAcquireError};
///
...
/// ```
/// use std::sync::Arc;
/// use crate::custom_tokio::sync::Semaphore;
///
/// #[crate::custom_tokio::main]
/// async fn main() {
...
/// [`Semaphore::acquire_owned`]: crate::custom_tokio::sync::Semaphore::acquire_owned
#[derive(Debug)]
...
///
/// [`acquire`]: crate::custom_tokio::sync::Semaphore::acquire()
#[must_use]
...
///
/// [`acquire_owned`]: crate::custom_tokio::sync::Semaphore::acquire_owned()
#[must_use]
#[clippy::has_significant_drop]
#[derive(Debug)]
pub(crate) struct OwnedSemaphorePermit {
    sem: Arc<Semaphore>,
    permits: u32,
}
...
impl Semaphore {
    ...
    pub(crate) const MAX_PERMITS: usize = super::batch_semaphore::Semaphore::MAX_PERMITS;
    ...
    /// ```
    ///
    /// [`AcquireError`]: crate::custom_tokio::sync::AcquireError
    /// [`SemaphorePermit`]: crate::custom_tokio::sync::SemaphorePermit
    ...
    /// [`AcquireError`]: crate::custom_tokio::sync::AcquireError
    /// [`SemaphorePermit`]: crate::custom_tokio::sync::SemaphorePermit
    pub(crate) async fn acquire_many(&self, n: u32) -> Result<SemaphorePermit<'_>, AcquireError> {
        #[cfg(all(tokio_unstable, feature = "tracing"))]
        trace::async_op(
    ...
    /// ```
    ///
    /// [`TryAcquireError::Closed`]: crate::custom_tokio::sync::TryAcquireError::Closed
    /// [`TryAcquireError::NoPermits`]: crate::custom_tokio::sync::TryAcquireError::NoPermits
    /// [`SemaphorePermit`]: crate::custom_tokio::sync::SemaphorePermit
    pub(crate) fn try_acquire(&self) -> Result<SemaphorePermit<'_>, TryAcquireError> {
    ...
    /// [`TryAcquireError::NoPermits`]: crate::custom_tokio::sync::TryAcquireError::NoPermits
    /// [`SemaphorePermit`]: crate::custom_tokio::sync::SemaphorePermit
    pub(crate) fn try_acquire_many(&self, n: u32) -> Result<SemaphorePermit<'_>, TryAcquireError> {
    ...
    /// [`Arc`]: std::sync::Arc
    /// [`AcquireError`]: crate::custom_tokio::sync::AcquireError
    /// [`OwnedSemaphorePermit`]: crate::custom_tokio::sync::OwnedSemaphorePermit
    ...
    /// use crate::custom_tokio::sync::Semaphore;
    /// use std::sync::Arc;
    /// use crate::custom_tokio::sync::TryAcquireError;
    ///
    /// #[crate::custom_tokio::main]
    /// async fn main() {
