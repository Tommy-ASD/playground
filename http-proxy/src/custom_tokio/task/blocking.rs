...
cfg_rt_multi_thread! {
    ...
    /// [`shutdown_timeout`]: fn@crate::custom_tokio::runtime::Runtime::shutdown_timeout
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`current_thread`]: fn@crate::custom_tokio::runtime::Builder::new_current_thread
    #[track_caller]
    pub(crate)fn block_in_place<F, R>(f: F) -> R
    where
        F: FnOnce() -> R,
    {
        crate::custom_tokio::runtime::scheduler::block_in_place(f)
    }
}
...
cfg_rt! {
    ...
    /// codebase.
    ///
    /// [`Builder`]: struct@crate::custom_tokio::runtime::Builder
    /// [blocking]: ../index.html#cpu-bound-tasks-and-blocking-code
    /// [rayon]: https://docs.rs/rayon
    /// [`mpsc channel`]: crate::custom_tokio::sync::mpsc
    ...
    where
        ...
        R: Send + 'static,
    {
        crate::custom_tokio::runtime::spawn_blocking(f)
    }
}
