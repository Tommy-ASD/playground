...
use crate::custom_tokio::time::{sleep_until, Duration, Instant, Sleep};
...
///
/// ```
/// use crate::custom_tokio::time::{interval_at, Duration, Instant};
///
/// #[crate::custom_tokio::main]
/// async fn main() {
...
pub(crate) enum MissedTickBehavior {
    ...
    ///
    /// ```
    /// use crate::custom_tokio::time::{interval, Duration};
    ...
    ///
    /// ```
    /// use crate::custom_tokio::time::{interval, Duration, MissedTickBehavior};
...
impl Interval {
    ...
    /// # Cancel safety
    ///
    /// This method is cancellation safe. If `tick` is used as the branch in a `crate::custom_tokio::select!` and
    ...
    /// }
    /// ```
    pub(crate) fn reset_immediately(&mut self) {
    ...
    /// Resets the interval to a [`crate::custom_tokio::time::Instant`] deadline.
    ///
    ...
    ///
    /// ```
    /// use crate::custom_tokio::time::{self, Instant};
    ///
    /// use std::time::Duration;
    ///
    /// #[crate::custom_tokio::main]
    ...
    pub(crate) fn missed_tick_behavior(&self) -> MissedTickBehavior {
        self.missed_tick_behavior
    }
