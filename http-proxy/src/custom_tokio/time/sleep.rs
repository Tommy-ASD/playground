use crate::custom_tokio::runtime::time::TimerEntry;
use crate::custom_tokio::time::{error::Error, Duration, Instant};
...
///
/// ```
/// use crate::custom_tokio::time::{sleep_until, Instant, Duration};
///
...
pin_project! {
    ...
    /// ```
    ///
    /// Use with [`select!`]. Pinning the `Sleep` with [`crate::custom_tokio::pin!`] is
    ...
    /// [`crate::custom_tokio::pin!`]: ../macro.pin.html
...
impl Sleep {
    ...
    ///
    /// ```
    /// use crate::custom_tokio::time::{Duration, Instant};
    ///
    /// # #[crate::custom_tokio::main(flavor = "current_thread")]
    /// # async fn main() {
    /// let sleep = crate::custom_tokio::time::sleep(Duration::from_millis(10));
    /// crate::custom_tokio::pin!(sleep);
    ///
    ...
    /// [crate::custom_tokio::time::Interval] where we want to reset the internal [Sleep]
    ...
    fn poll_elapsed(self: Pin<&mut Self>, cx: &mut task::Context<'_>) -> Poll<Result<(), Error>> {
        ...
        let coop = ready!(trace_poll_op!(
            "poll_elapsed",
            crate::custom_tokio::runtime::coop::poll_proceed(cx),
        ));
