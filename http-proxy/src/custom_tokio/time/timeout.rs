...
/// [`Elapsed`]: crate::custom_tokio::time::error::Elapsed
///
/// # Cancellation
///
...
///
/// ```rust
/// use crate::custom_tokio::time::timeout;
...
///
/// ```rust
/// use crate::custom_tokio::time::{Instant, timeout_at};
/// use crate::custom_tokio::sync::oneshot;
///
/// use std::time::Duration;
///
...
/// # }
/// ```
pub(crate) fn timeout_at<F>(deadline: Instant, future: F) -> Timeout<F>
where
    F: Future,
{
