...
use crate::hyper::client::conn;
use crate::hyper::rt::Executor as _;
...
enum Tx {
    #[cfg(feature = "http1")]
    Http1(conn::http1::SendRequest<crate::hyper::body::Incoming>),
    #[cfg(feature = "http2")]
    Http2(conn::http2::SendRequest<crate::hyper::body::Incoming>),
}
        ...
        Box::into_raw(hyper_task::boxed(async move {
            ...
            if options.http2 {
                return conn::http2::Builder::new(options.exec.clone())
                    .handshake::<_, crate::hyper::body::Incoming>(io)
                    .await
                    .map(|(tx, conn)| {
