...
pub use crate::hyper::http::{header, Method, Request, Response, StatusCode, Uri, Version};

#[doc(no_inline)]
pub use crate::hyper::http::HeaderMap;

pub use crate::hyper::error::{Error, Result};
