...
use crate::hyper::{common::time::Time, rt::Timer};
    ...
    B::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub fn without_shutdown(self) -> impl Future<Output = crate::hyper::Result<Parts<I, S>>>
    where
        S: Unpin,
        S::Future: Unpin,
        B: Unpin,
    ...
    ///
    /// See [the `upgrade` module](crate::hyper::upgrade) for more.
...
impl Builder {
    ...
    /// Bind a connection together with a [`Service`](crate::hyper::service::Service).
    ///
