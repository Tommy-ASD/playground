...
pub(crate) trait ToSocketAddrs: sealed::ToSocketAddrsPriv {}
...
impl sealed::ToSocketAddrsPriv for str {
    ...
    fn to_socket_addrs(&self, _: sealed::Internal) -> Self::Future {
        use crate::tcpstream::blocking::spawn_blocking;
...
pub(crate) mod sealed {
    ...
    #[doc(hidden)]
    pub(crate) trait ToSocketAddrsPriv {
    ...
    use crate::ready;
    use crate::tcpstream::blocking::JoinHandle;
    ...
    #[doc(hidden)]
    #[derive(Debug)]
    pub(crate) struct MaybeReady(pub(crate) State);
