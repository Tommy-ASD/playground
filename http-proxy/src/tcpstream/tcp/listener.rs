use crate::ready;
use crate::tcpstream::io::{Interest, PollEvented};
use crate::tcpstream::tcp::TcpStream;
...
impl TcpListener {
    ...
    ///
    /// [`TcpStream`]: struct@crate::tcpstream::net::TcpStream
    ///
    /// # Examples
    ///
    /// ```no_run
...
// cfg_windows! {
//     use crate::tcpstream::os::windows::io::{AsRawSocket, RawSocket, AsSocket, BorrowedSocket};
