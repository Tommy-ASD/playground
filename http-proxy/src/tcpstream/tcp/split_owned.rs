...
use crate::bidirectional::io::{AsyncRead, AsyncWrite, Interest, ReadBuf, Ready};
use crate::tcpstream::future::poll_fn;
use crate::tcpstream::net::TcpStream;
...
/// [`TcpStream`]: TcpStream
/// [`into_split`]: TcpStream::into_split()
/// [`AsyncWrite`]: trait@crate::tcpstream::io::AsyncWrite
/// [`poll_shutdown`]: fn@crate::tcpstream::io::AsyncWrite::poll_shutdown
...
impl OwnedReadHalf {
    ...
    ///
    /// [`into_split`]: TcpStream::into_split()
    pub(crate) fn reunite(self, other: OwnedWriteHalf) -> Result<TcpStream, ReuniteError> {
        reunite(self, other)
    }
...
impl OwnedWriteHalf {
    ...
    ///
    /// [`into_split`]: TcpStream::into_split()
    pub(crate) fn reunite(self, other: OwnedReadHalf) -> Result<TcpStream, ReuniteError> {
        reunite(other, self)
    }
