use crate::ready;
use crate::tcpstream::tcp::poll_fn;
use crate::tcpstream::{to_socket_addrs, ToSocketAddrs};
use std::time::Duration;

use crate::bidirectional::io::{AsyncRead, AsyncWrite, Interest, PollEvented, ReadBuf, Ready};
use crate::tcpstream::tcp::split::{split, ReadHalf, WriteHalf};
use crate::tcpstream::tcp::split_owned::{split_owned, OwnedReadHalf, OwnedWriteHalf};
...
/// [accepting]: method@crate::tcpstream::net::TcpListener::accept
/// [listener]: struct@crate::tcpstream::net::TcpListener
/// [`TcpSocket`]: struct@crate::tcpstream::net::TcpSocket
/// [`AsyncReadExt`]: trait@crate::tcpstream::io::AsyncReadExt
/// [`AsyncWriteExt`]: trait@crate::tcpstream::io::AsyncWriteExt
///
/// # Examples
///
/// ```no_run
...
///
/// [`write_all`]: fn@crate::tcpstream::io::AsyncWriteExt::write_all
/// [`AsyncWriteExt`]: trait@crate::tcpstream::io::AsyncWriteExt
///
...
///
/// [`shutdown()`]: fn@crate::tcpstream::io::AsyncWriteExt::shutdown
...
impl TcpStream {
    ...
    /// type.
    ///
    /// [`ToSocketAddrs`]: trait@crate::tcpstream::net::ToSocketAddrs
    /// [`TcpSocket`]: struct@crate::tcpstream::net::TcpSocket
    ///
    /// # Examples
    ///
    ...
    ///
    /// [`read`]: fn@crate::tcpstream::io::AsyncReadExt::read
    /// [`AsyncReadExt`]: trait@crate::tcpstream::io::AsyncReadExt
...
// use crate::tcpstream::os::windows::io::{AsRawSocket, AsSocket, BorrowedSocket, RawSocket};
