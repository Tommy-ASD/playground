use crate::bidirectional::io::{Interest, PollEvented, ReadBuf, Ready};
use crate::ready;
use crate::tcpstream::{to_socket_addrs, ToSocketAddrs};
...
impl UdpSocket {
    ...
    /// explicitly with [`Runtime::enter`](crate::tcpstream::runtime::Runtime::enter) function.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// [`crate::custom_tokio::select!`](crate::tcpstream::select) statement and some other branch
    ...
    /// }
    /// ```
    pub(crate) fn try_recv_buf_from<B: BufMut>(
        &self,
        buf: &mut B,
    ...
    /// }
    /// ```
    pub(crate) async fn recv_buf_from<B: BufMut>(
        &self,
        buf: &mut B,
    ) -> io::Result<(usize, SocketAddr)> {
        self.io
    ...
    ///
    /// [`ToSocketAddrs`]: crate::tcpstream::net::ToSocketAddrs
    ///
    /// # Cancel safety
    ///
...
// cfg_windows! {
//     use crate::tcpstream::os::windows::io::{AsRawSocket, RawSocket};
//     use crate::tcpstream::os::windows::io::{AsSocket, BorrowedSocket};
