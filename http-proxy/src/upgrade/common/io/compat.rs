    ...
    T: crate::upgrade::rt::Read,
{
    fn poll_read(
        ...
        let (new_init, new_filled) = unsafe {
            let mut buf = crate::upgrade::rt::ReadBuf::uninit(tbuf.inner_mut());
            buf.set_init(init);
            buf.set_filled(filled);

            match crate::upgrade::rt::Read::poll_read(self.p(), cx, buf.unfilled()) {
    ...
    T: crate::upgrade::rt::Write,
{
    fn poll_write(
        ...
        crate::upgrade::rt::Write::poll_write(self.p(), cx, buf)
    }

    fn poll_flush(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Result<(), std::io::Error>> {
        crate::upgrade::rt::Write::poll_flush(self.p(), cx)
    }
    ...
    fn poll_shutdown(
        ...
        crate::upgrade::rt::Write::poll_shutdown(self.p(), cx)
    }

    fn is_write_vectored(&self) -> bool {
        crate::upgrade::rt::Write::is_write_vectored(&self.0)
    }
    ...
    fn poll_write_vectored(
        ...
        crate::upgrade::rt::Write::poll_write_vectored(self.p(), cx, bufs)
    }
}
