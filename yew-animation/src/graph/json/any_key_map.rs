...
/// try_main().unwrap();
/// ```
use crate::graph::json::serde_with_utils;
    ...
    V: Serialize + 's,
{
    ...
    let wrap = crate::graph::json::map_iter_to_json::SerializeMapIterWrapper {
...
/// See docs for [any_key_map](index.html).
pub fn deserialize<'d, D, C, K, V>(deserializer: D) -> Result<C, D::Error>
where
    D: Deserializer<'d>,
...
#[cfg(test)]
mod tests {
    use crate::graph::json::any_key_map;
